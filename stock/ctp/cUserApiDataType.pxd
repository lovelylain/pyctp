...
cdef extern from "ThostFtdcUserApiDataTypeSSE.h":
    ...
    enum: D_TransferSecuritiesIn "THOST_FTDC_D_TransferSecuritiesIn" #担保品划转入信用账户
    enum: D_TransferSecuritiesOut "THOST_FTDC_D_TransferSecuritiesOut" #担保品划转出信用账户
    enum: D_CashIn "THOST_FTDC_D_CashIn" #现金替代，只用作回报
    ...
    enum: TPID_RepayShortSellAlgo "THOST_FTDC_TPID_RepayShortSellAlgo" #融资融券买券还券算法
    ...
    ctypedef char TRepayShortSellAlgoType "TZQThostFtdcRepayShortSellAlgoType" #买券还券算法
    enum: SSA_Original "THOST_FTDC_SSA_Original" #默认算法
    enum: SSA_Ratio "THOST_FTDC_SSA_Ratio" #按还券比例计算
    enum: SSA_Min "THOST_FTDC_SSA_Min" #Min[1,2]
    ...
    ctypedef char TSysOperTypeType "TZQThostFtdcSysOperTypeType" #系统日志操作类型
    ...
    ctypedef char TSysOperModeType "TZQThostFtdcSysOperModeType" #系统日志操作方法
    ...
    ctypedef char[161] TCommModelNameType "TZQThostFtdcCommModelNameType" #手续费率模板名称
    ctypedef char[1025] TCommModelMemoType "TZQThostFtdcCommModelMemoType" #手续费率模板备注
    ctypedef int TAutoIncrementType "TZQThostFtdcAutoIncrementType" #自增长序号
    ctypedef char TInstrumentRangeType "TZQThostFtdcInstrumentRangeType" #股票权限分类
    enum: INR_All "THOST_FTDC_INR_All" #所有
    enum: INR_Product "THOST_FTDC_INR_Product" #产品
    enum: INR_Model "THOST_FTDC_INR_Model" #股票权限模版
    enum: INR_Stock "THOST_FTDC_INR_Stock" #股票
    ctypedef char[31] TRightModelIDType "TZQThostFtdcRightModelIDType" #股票权限模版代码
    ctypedef char[161] TRightModelNameType "TZQThostFtdcRightModelNameType" #股票权限模版名称
    ctypedef char[1025] TRightModelMemoType "TZQThostFtdcRightModelMemoType" #股票权限模版备注
    ctypedef int TYear1Type "TZQThostFtdcYear1Type" #年份
    ctypedef int TMonth1Type "TZQThostFtdcMonth1Type" #月份
