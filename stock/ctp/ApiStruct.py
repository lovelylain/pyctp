...
D_TransferSecuritiesIn = 'a' #担保品划转入信用账户
D_TransferSecuritiesOut = 'b' #担保品划转出信用账户
D_CashIn = 'c' #现金替代，只用作回报
PT_Net = '1' #净持仓
PT_Gross = '2' #综合持仓
PD_Net = '1' #净
PD_Long = '2' #多头
...
TPID_RepayShortSellAlgo = 'S' #融资融券买券还券算法
...
class TransferBankToFutureReq(BaseStruct): #银行资金转期货请求，TradeCode=202001
    def __init__(self, FutureAccount='', FuturePwdFlag='', FutureAccPwd='', TradeAmt=0.0, CustFee=0.0, CurrencyCode=''):
        self.FutureAccount = 'TAccountID' #期货资金账户, char[15]
...
class TransferBankToFutureRsp(BaseStruct): #银行资金转期货请求响应
    def __init__(self, RetCode='', RetInfo='', FutureAccount='', TradeAmt=0.0, CustFee=0.0, CurrencyCode=''):
        ...
        self.FutureAccount = 'TAccountID' #资金账户, char[15]
...
class Product(BaseStruct): #产品
    def __init__(self, ProductID='', ProductName='', ExchangeID='', ProductClass='', VolumeMultiple=0, PriceTick=0.0, MaxMarketOrderVolume=0, MinMarketOrderVolume=0, MaxLimitOrderVolume=0, MinLimitOrderVolume=0, PositionType='', PositionDateType='', EFTMinTradeVolume=0):
        ...
        self.EFTMinTradeVolume = 'TVolume' #ETF最小交易单位, int
...
class Instrument(BaseStruct): #合约
    def __init__(self, InstrumentID='', ExchangeID='', InstrumentName='', ExchangeInstID='', ProductID='', ProductClass='', DeliveryYear=0, DeliveryMonth=0, MaxMarketOrderVolume=0, MinMarketOrderVolume=0, MaxLimitOrderVolume=0, MinLimitOrderVolume=0, VolumeMultiple=0, PriceTick=0.0, CreateDate='', OpenDate='', ExpireDate='', StartDelivDate='', EndDelivDate='', InstLifePhase='', IsTrading=0, PositionType='', PositionDateType='', OrderCanBeWithdraw=0, MinBuyVolume=0, MinSellVolume=0, RightModelID=''):
        ...
        self.PositionType = 'TPositionType' #持仓类型, char
        self.PositionDateType = 'TPositionDateType' #持仓日期类型, char
        self.OrderCanBeWithdraw = 'TBool' #报单能否撤单, int
        self.MinBuyVolume = 'TVolume' #最小买下单单位, int
        self.MinSellVolume = 'TVolume' #最小卖下单单位, int
        self.RightModelID = 'TRightModelID' #股票权限模版代码, char[31]
...
class Trader(BaseStruct): #交易所交易员
    def __init__(self, ExchangeID='', TraderID='', ParticipantID='', Password='', InstallCount=0, BrokerID='', BranchID=''):
        ...
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.BranchID = 'TBranchID' #营业部编号, char[9]
...
class Investor(BaseStruct): #投资者
    def __init__(self, InvestorID='', BrokerID='', InvestorGroupID='', InvestorName='', IdentifiedCardType='', IdentifiedCardNo='', IsActive=0, Telephone='', Address='', OpenDate='', Mobile='', SHBranchID='', SZBranchID='', IsCreditAccount=0):
        self.InvestorID = 'TInvestorID' #投资者代码, char[15]
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorGroupID = 'TInvestorID' #投资者分组代码, char[15]
        ...
        self.SHBranchID = 'TBranchID' #上海营业部编号, char[9]
        self.SZBranchID = 'TBranchID' #深圳营业部编号, char[9]
        self.IsCreditAccount = 'TBool' #是否信用账户, int
...
class TradingAccount(BaseStruct): #资金账户
    def __init__(self, BrokerID='', AccountID='', PreMortgage=0.0, PreCredit=0.0, PreDeposit=0.0, PreBalance=0.0, PreMargin=0.0, InterestBase=0.0, Interest=0.0, Deposit=0.0, Withdraw=0.0, FrozenMargin=0.0, FrozenCash=0.0, FrozenCommission=0.0, CurrMargin=0.0, CashIn=0.0, Commission=0.0, CloseProfit=0.0, PositionProfit=0.0, Balance=0.0, Available=0.0, WithdrawQuota=0.0, Reserve=0.0, TradingDay='', SettlementID=0, Credit=0.0, Mortgage=0.0, ExchangeMargin=0.0, DeliveryMargin=0.0, ExchangeDeliveryMargin=0.0, FrozenTransferFee=0.0, FrozenStampTax=0.0, TransferFee=0.0, StampTax=0.0, ConversionAmount=0.0, CreditAmount=0.0, LowLimitRatio=0.0, MarginTradingAmount=0.0, ShortSellingAmount=0.0, MarginTradingAvail=0.0, ShortSellingAvail=0.0, CreditRatio=0.0, StockValue=0.0, SSStockValue=0.0, BondRepurchaseValue=0.0):
        ...
        self.FrozenTransferFee = 'TMoney' #冻结的过户费, double
        self.FrozenStampTax = 'TMoney' #冻结的印花税, double
        self.TransferFee = 'TMoney' #过户费, double
        self.StampTax = 'TMoney' #印花税, double
        self.ConversionAmount = 'TMoney' #折算金额, double
        self.CreditAmount = 'TMoney' #授信额度, double
        self.LowLimitRatio = 'TRatio' #最低维持担保比例, double
        self.MarginTradingAmount = 'TMoney' #融资买入金额, double
        self.ShortSellingAmount = 'TMoney' #融券卖出金额, double
        self.MarginTradingAvail = 'TMoney' #融资买入可用金额, double
        self.ShortSellingAvail = 'TMoney' #融券卖出可用金额, double
        self.CreditRatio = 'TRatio' #维持担保比例, double
        self.StockValue = 'TMoney' #证券总价值, double
        self.SSStockValue = 'TMoney' #融券总市值, double
        self.BondRepurchaseValue = 'TMoney' #国债回购占用资金, double
...
class InvestorPosition(BaseStruct): #投资者持仓
    def __init__(self, InstrumentID='', BrokerID='', InvestorID='', PosiDirection='', HedgeFlag='', PositionDate='', YdPosition=0, Position=0, LongFrozen=0, ShortFrozen=0, LongFrozenAmount=0.0, ShortFrozenAmount=0.0, OpenVolume=0, CloseVolume=0, OpenAmount=0.0, CloseAmount=0.0, PositionCost=0.0, FrozenCash=0.0, CashIn=0.0, Commission=0.0, CloseProfit=0.0, PositionProfit=0.0, PreSettlementPrice=0.0, SettlementPrice=0.0, TradingDay='', SettlementID=0, OpenCost=0.0, ExchangeMargin=0.0, TodayPosition=0, TransferFee=0.0, StampTax=0.0, TodayPurRedVolume=0, ConversionRate=0.0, ConversionAmount=0.0, MarginTradeVolume=0, MarginTradeAmount=0.0, MarginTradeFrozenVolume=0, MarginTradeFrozenAmount=0.0, MarginTradeConversionAmount=0.0, ShortSellVolume=0, ShortSellAmount=0.0, ShortSellConversionAmount=0.0, ShortSellFrozenVolume=0, ShortSellFrozenAmount=0.0, StockValue=0.0, ExchangeID='', TodayMTPosition=0, TodaySSPosition=0, SSStockValue=0.0):
        ...
        self.TransferFee = 'TMoney' #过户费, double
        self.StampTax = 'TMoney' #印花税, double
        self.TodayPurRedVolume = 'TVolume' #今日申购赎回数量, int
        self.ConversionRate = 'TRatio' #折算率, double
        self.ConversionAmount = 'TMoney' #折算金额, double
        self.MarginTradeVolume = 'TVolume' #融资买入出数量, int
        self.MarginTradeAmount = 'TMoney' #融资买入金额, double
        self.MarginTradeFrozenVolume = 'TVolume' #融资买入冻结数量, int
        self.MarginTradeFrozenAmount = 'TMoney' #融资买入冻结金额, double
        self.MarginTradeConversionAmount = 'TMoney' #融资买入盈亏, double
        self.ShortSellVolume = 'TVolume' #融券卖出数量, int
        self.ShortSellAmount = 'TMoney' #融券卖出金额, double
        self.ShortSellConversionAmount = 'TMoney' #融券卖出盈亏, double
        self.ShortSellFrozenVolume = 'TVolume' #融券卖出冻结数量, int
        self.ShortSellFrozenAmount = 'TMoney' #融券卖出冻结金额, double
        self.StockValue = 'TMoney' #证券价值, double
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.TodayMTPosition = 'TVolume' #今日融资持仓, int
        self.TodaySSPosition = 'TVolume' #今日融券持仓, int
        self.SSStockValue = 'TMoney' #融券总市值, double
...
class InstrumentCommissionRate(BaseStruct): #合约手续费率
    def __init__(self, InstrumentID='', InvestorRange='', BrokerID='', InvestorID='', Direction='', StampTaxRateByMoney=0.0, StampTaxRateByVolume=0.0, TransferFeeRateByMoney=0.0, TransferFeeRateByVolume=0.0, TradeFeeByMoney=0.0, TradeFeeByVolume=0.0, MarginByMoney=0.0, MinTradeFee=0.0):
        ...
        self.StampTaxRateByMoney = 'TRatio' #印花税率, double
        self.StampTaxRateByVolume = 'TRatio' #印花税率(按手数), double
        self.TransferFeeRateByMoney = 'TRatio' #过户费率, double
        self.TransferFeeRateByVolume = 'TRatio' #过户费率(按手数), double
        self.TradeFeeByMoney = 'TRatio' #交易费, double
        self.TradeFeeByVolume = 'TRatio' #交易费(按手数), double
        self.MarginByMoney = 'TRatio' #交易附加费率, double
        self.MinTradeFee = 'TPrice' #最小过户费, double
...
class InstrumentTradingRight(BaseStruct): #投资者合约交易权限
    def __init__(self, InstrumentID='', InvestorRange='', BrokerID='', InvestorID='', Direction='', TradingRight='', ExchangeID='', InstrumentRange=''):
        ...
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.InstrumentRange = 'TInstrumentRange' #股票权限分类, char
...
class InputOrder(BaseStruct): #输入报单
    def __init__(self, BrokerID='', InvestorID='', InstrumentID='', OrderRef='', UserID='', ExchangeID='', OrderPriceType='', Direction='', CombOffsetFlag='', CombHedgeFlag='', LimitPrice='', VolumeTotalOriginal=0, TimeCondition='', GTDDate='', VolumeCondition='', MinVolume=0, ContingentCondition='', StopPrice=0.0, ForceCloseReason='', IsAutoSuspend=0, BusinessUnit='', RequestID=0, UserForceClose=0):
        ...
        self.LimitPrice = 'TStockPrice' #价格, char[9]
...
class Order(BaseStruct): #报单
    def __init__(self, BrokerID='', InvestorID='', InstrumentID='', OrderRef='', UserID='', ExchangeID='', OrderPriceType='', Direction='', CombOffsetFlag='', CombHedgeFlag='', LimitPrice='', VolumeTotalOriginal=0, TimeCondition='', GTDDate='', VolumeCondition='', MinVolume=0, ContingentCondition='', StopPrice=0.0, ForceCloseReason='', IsAutoSuspend=0, BusinessUnit='', RequestID=0, OrderLocalID='', ParticipantID='', ClientID='', ExchangeInstID='', TraderID='', InstallID=0, OrderSubmitStatus='', NotifySequence=0, TradingDay='', SettlementID=0, OrderSysID='', OrderSource='', OrderStatus='', OrderType='', VolumeTraded=0, VolumeTotal=0, InsertDate='', InsertTime='', ActiveTime='', SuspendTime='', UpdateTime='', CancelTime='', ActiveTraderID='', ClearingPartID='', SequenceNo=0, FrontID=0, SessionID=0, UserProductInfo='', StatusMsg='', UserForceClose=0, ActiveUserID='', BrokerOrderSeq=0, RelativeOrderSysID='', BranchID='', TradeAmount=0.0, IsETF=0, AccountID=''):
        ...
        self.BranchID = 'TBranchID' #营业部编号, char[9]
        self.TradeAmount = 'TMoney' #成交数量, double
        self.IsETF = 'TBool' #是否ETF, int
        self.AccountID = 'TAccountID' #资金帐号, char[15]
...
class ExchangeTrade(BaseStruct): #交易所成交
    def __init__(self, ExchangeID='', TradeID='', Direction='', OrderSysID='', ParticipantID='', ClientID='', TradingRole='', ExchangeInstID='', OffsetFlag='', HedgeFlag='', Price='', Volume=0, TradeDate='', TradeTime='', TradeType='', PriceSource='', TraderID='', OrderLocalID='', ClearingPartID='', BusinessUnit='', SequenceNo=0):
        ...
        self.HedgeFlag = 'THedgeFlag' #投机套保标志, char
        self.Price = 'TStockPrice' #价格, char[9]
        self.Volume = 'TVolume' #数量, int
...
class InvestorPositionDetail(BaseStruct): #投资者持仓明细
    def __init__(self, InstrumentID='', BrokerID='', InvestorID='', HedgeFlag='', Direction='', OpenDate='', TradeID='', Volume=0, OpenPrice=0.0, TradingDay='', SettlementID=0, TradeType='', ExchangeID='', Margin=0.0, ExchMargin=0.0, LastSettlementPrice=0.0, SettlementPrice=0.0, CloseVolume=0, CloseAmount=0.0, TransferFee=0.0, StampTax=0.0, Commission=0.0, Amount=0.0):
        ...
        self.StampTax = 'TMoney' #印花税, double
        self.Commission = 'TMoney' #手续费, double
        self.Amount = 'TMoney' #融资融券金额, double
...
def _init():
    ...
    T['TBranchID'] = c_char * 9 #营业部编号
    T['TTableName'] = c_char * 17 #和交易所交换表编号
    T['TStockPrice'] = c_char * 9 #证券交易价格
    T['TStockTradeType'] = c_char #证券交易类型
    T['TStockSeq'] = c_char * 11 #股票使用流水号
    T['TStockWth'] = c_int #股票使用流水号
    T['TWTFS'] = c_int #委托方式
    T['TWTLB'] = c_int #委托类别
    T['TWTRQ'] = c_int #委托日期
    T['TCreationredemptionStatus'] = c_char #基金当天申购赎回状态
    T['TETFCurrenceReplaceStatus'] = c_char #E    T['TF']现金替代标志
    T['TRepayShortSellAlgo'] = c_char #买券还券算法
    T['TINTEGER'] = c_int #一般整型
    T['TINT3'] = c_int #三位数整型
    T['TINT6'] = c_int #六位数整型
    T['TREAL9P3'] = c_double #九点三实型
    T['TREAL10P4'] = c_double #十点四实型
    T['TREAL16P2'] = c_double #十六点二实型
    T['TREAL16P8'] = c_double #十六点八实型
    T['TREAL22P2'] = c_double #二十二点二实型
    T['TCHAR1'] = c_char * 2 #一字节CHAR
    T['TCHAR2'] = c_char * 3 #二字节CHAR
    T['TCHAR3'] = c_char * 4 #三字节CHAR
    T['TCHAR4'] = c_char * 5 #四字节CHAR
    T['TCHAR5'] = c_char * 6 #五字节CHAR
    T['TCHAR6'] = c_char * 7 #六字节CHAR
    T['TCHAR8'] = c_char * 9 #八字节CHAR
    T['TCHAR10'] = c_char * 11 #十字节CHAR
    T['TCHAR12'] = c_char * 13 #十二字节CHAR
    T['TCHAR13'] = c_char * 14 #十三字节CHAR
    T['TCHAR14'] = c_char * 15 #十四字节CHAR
    T['TCHAR16'] = c_char * 17 #十六字节CHAR
    T['TVCHAR4'] = c_char * 5 #四字节VCHAR
    T['TVCHAR6'] = c_char * 7 #六字节VCHAR
    T['TVCHAR8'] = c_char * 9 #八字节VCHAR
    T['TVCHAR10'] = c_char * 11 #十字节VCHAR
    T['TVCHAR12'] = c_char * 13 #十二字节VCHAR
    T['TVCHAR16'] = c_char * 17 #十六字节VCHAR
    T['TVCHAR20'] = c_char * 21 #二十字节VCHAR
    T['TVCHAR30'] = c_char * 31 #三十字节VCHAR
    T['TVCHAR50'] = c_char * 51 #五十字节VCHAR
    T['TVCHAR60'] = c_char * 61 #六十字节VCHAR
    T['TVCHAR65'] = c_char * 66 #六十五字节VCHAR
    T['TVCHAR80'] = c_char * 81 #八十字节VCHAR
    T['TVCHAR255'] = c_char * 256 #二五五字节VCHAR
    ...
    T['TAutoIncrement'] = c_int #自增长序号
    T['TInstrumentRange'] = c_char #股票权限分类
    T['TRightModelID'] = c_char * 31 #股票权限模版代码
    T['TRightModelName'] = c_char * 161 #股票权限模版名称
    T['TRightModelMemo'] = c_char * 1025 #股票权限模版备注
    T['TYear1'] = c_int #年份
    T['TMonth1'] = c_int #月份
