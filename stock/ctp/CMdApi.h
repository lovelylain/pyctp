...
static inline int MdSpi_OnRspUserLogin(PyObject *, CZQThostFtdcRspUserLoginField *, CZQThostFtdcRspInfoField *, int, bool);
static inline int MdSpi_OnRspUserLogout(PyObject *, CZQThostFtdcUserLogoutField *, CZQThostFtdcRspInfoField *, int, bool);
static inline int MdSpi_OnRspError(PyObject *, CZQThostFtdcRspInfoField *, int, bool);
static inline int MdSpi_OnRspSubMarketData(PyObject *, CZQThostFtdcSpecificInstrumentField *, CZQThostFtdcRspInfoField *, int, bool);
static inline int MdSpi_OnRspUnSubMarketData(PyObject *, CZQThostFtdcSpecificInstrumentField *, CZQThostFtdcRspInfoField *, int, bool);
static inline int MdSpi_OnRtnDepthMarketData(PyObject *, CZQThostFtdcDepthMarketDataField *);
...
static CZQThostFtdcMdApi *g_GcApi = NULL;
