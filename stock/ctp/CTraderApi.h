...
static inline void TraderSpi_OnRspTradingAccountPasswordUpdate(PyObject *, CZQThostFtdcTradingAccountPasswordUpdateField *, CZQThostFtdcRspInfoField *, int, bool);
