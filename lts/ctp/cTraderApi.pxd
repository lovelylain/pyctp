...
cdef extern from "SecurityFtdcTraderApi.h":
    cdef cppclass CTraderApi "CSecurityFtdcTraderApi":
        void Release() nogil
        void Init() nogil
        int Join() nogil
        ...
        int ReqQryBondInterest(CQryBondInterestField *pQryBondInterest, int nRequestID) nogil
        int ReqQryMarketRationInfo(CQryMarketRationInfoField *pQryMarketRationInfo, int nRequestID) nogil
        ...
        int ReqFundOutByLiber(CInputFundTransferField *pInputFundTransfer, int nRequestID) nogil
        int ReqQryFundTransferSerial(CQryFundTransferSerialField *pQryFundTransferSerial, int nRequestID) nogil

cdef extern from "SecurityFtdcTraderApi.h" namespace "CSecurityFtdcTraderApi":
...
cdef extern from "CTraderApi.h":
    ...
    cdef const_char *S___name__, *S_ctypes, *S_addressof, *S_from_address, *S_BondInterest, *S_DepthMarketData, *S_Exchange, *S_FundTransfer, *S_InputFundTransfer, *S_InputOrder, *S_InputOrderAction, *S_Instrument, *S_InstrumentCommissionRate, *S_Investor, *S_InvestorPosition, *S_MarketRationInfo, *S_Order, *S_OrderAction, *S_RspInfo, *S_RspUserLogin, *S_Trade, *S_TradingAccount, *S_TradingAccountPasswordUpdate, *S_TradingCode, *S_UserLogout, *S_UserPasswordUpdate
