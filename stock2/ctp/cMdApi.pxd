...
cdef extern from "ThostFtdcMdApiSSE.h":
    cdef cppclass CMdApi "CZQThostFtdcMdApi":
        void Release() nogil
        void Init() nogil
        int Join() nogil
...
cdef extern from "ThostFtdcMdApiSSE.h" namespace "CZQThostFtdcMdApi":
    CMdApi *CreateFtdcMdApi(const_char *pszFlowPath, cbool bIsUsingUdp) nogil except +
