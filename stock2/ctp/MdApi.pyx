...
cdef ApiStruct_addressof, ApiStruct_DepthMarketData, ApiStruct_RspInfo, ApiStruct_RspUserLogin, ApiStruct_SpecificInstrument, ApiStruct_UserLogout
cdef extern _init(self, m):
    global ApiStruct_addressof, ApiStruct_DepthMarketData, ApiStruct_RspInfo, ApiStruct_RspUserLogin, ApiStruct_SpecificInstrument, ApiStruct_UserLogout
...
cdef class MdApi:
    ...
    def Create(self, const_char *pszFlowPath="", cbool bIsUsingUdp=False):
        ...
        self.api = CreateFtdcMdApi(pszFlowPath, bIsUsingUdp)
