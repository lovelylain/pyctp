...
class QryProductGroup(BaseStruct): #查询产品组
    def __init__(self, ProductID='', ExchangeID=''):
        self.ProductID = 'InstrumentID' #产品代码, char[31]
        self.ExchangeID = '' #交易所代码, char[9]

class ProductGroup(BaseStruct): #投资者品种/跨品种保证金产品组
    def __init__(self, ProductID='', ExchangeID='', ProductGroupID=''):
        self.ProductID = 'InstrumentID' #产品代码, char[31]
        self.ExchangeID = '' #交易所代码, char[9]
        self.ProductGroupID = 'InstrumentID' #产品组代码, char[31]
