...
cdef extern from "ThostFtdcTraderApi.h":
    cdef cppclass CTraderApi "CThostFtdcTraderApi":
        ...
        int ReqBatchOrderAction(CInputBatchOrderActionField *pInputBatchOrderAction, int nRequestID) nogil
        ...
        int ReqQryProductGroup(CQryProductGroupField *pQryProductGroup, int nRequestID) nogil
