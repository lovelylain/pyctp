...
class RspUserLogin(BaseStruct): #用户登录应答
    def __init__(self, TradingDay='', LoginTime='', BrokerID='', UserID='', SystemName='', FrontID=0, SessionID=0, MaxOrderRef='', SHFETime='', DCETime='', CZCETime='', FFEXTime=''):
        ...
        self.MaxOrderRef = 'TOrderRef' #最大报单引用, char[13]
        self.SHFETime = 'TTime' #上期所时间, char[9]
        self.DCETime = 'TTime' #大商所时间, char[9]
        self.CZCETime = 'TTime' #郑商所时间, char[9]
        self.FFEXTime = 'TTime' #中金所时间, char[9]
...
class TransferHeader(BaseStruct): #银期转帐报文头
    def __init__(self, Version='', TradeCode='', TradeDate='', TradeTime='', TradeSerial='', FutureID='', BankID='', BankBrchID='', OperNo='', DeviceID='', RecordNum='', SessionID=0, RequestID=0):
        self.Version = 'TVersion' #版本号，常量，1.0, char[4]
        self.TradeCode = 'TTradeCode' #交易代码，必填, char[7]
        self.TradeDate = 'TTradeDate' #交易日期，必填，格式：yyyymmdd, char[9]
        self.TradeTime = 'TTradeTime' #交易时间，必填，格式：hhmmss, char[9]
        self.TradeSerial = 'TTradeSerial' #发起方流水号，N/A, char[9]
        self.FutureID = 'TFutureID' #期货公司代码，必填, char[11]
        self.BankID = 'TBankID' #银行代码，根据查询银行得到，必填, char[4]
        self.BankBrchID = 'TBankBrchID' #银行分中心代码，根据查询银行得到，必填, char[5]
        self.OperNo = 'TOperNo' #操作员，N/A, char[17]
        self.DeviceID = 'TDeviceID' #交易设备类型，N/A, char[3]
        self.RecordNum = 'TRecordNum' #记录数，N/A, char[7]
        self.SessionID = 'TSessionID' #会话编号，N/A, int
        self.RequestID = 'TRequestID' #请求编号，N/A, int
...
class TransferBankToFutureReq(BaseStruct): #银行资金转期货请求，TradeCode=202001
    def __init__(self, FutureAccount='', FuturePwdFlag='', FutureAccPwd='', TradeAmt=0.0, CustFee=0.0, CurrencyCode=''):
        self.FutureAccount = 'TAccountID' #期货资金账户, char[13]
        self.FuturePwdFlag = 'TFuturePwdFlag' #密码标志, char
        self.FutureAccPwd = 'TFutureAccPwd' #密码, char[17]
        self.TradeAmt = 'TMoney' #转账金额, double
        self.CustFee = 'TMoney' #客户手续费, double
        self.CurrencyCode = 'TCurrencyCode' #币种：RMB-人民币 USD-美圆 HKD-港元, char[4]
...
class TransferBankToFutureRsp(BaseStruct): #银行资金转期货请求响应
    def __init__(self, RetCode='', RetInfo='', FutureAccount='', TradeAmt=0.0, CustFee=0.0, CurrencyCode=''):
        self.RetCode = 'TRetCode' #响应代码, char[5]
        self.RetInfo = 'TRetInfo' #响应信息, char[129]
        self.FutureAccount = 'TAccountID' #资金账户, char[13]
        self.TradeAmt = 'TMoney' #转帐金额, double
        self.CustFee = 'TMoney' #应收客户手续费, double
        self.CurrencyCode = 'TCurrencyCode' #币种, char[4]
...
class TransferQryBankRsp(BaseStruct): #查询银行资金请求响应
    def __init__(self, RetCode='', RetInfo='', FutureAccount='', TradeAmt=0.0, UseAmt=0.0, FetchAmt=0.0, CurrencyCode=''):
        ...
        self.RetInfo = 'TRetInfo' #响应信息, char[129]
        self.FutureAccount = 'TAccountID' #资金账户, char[13]
        self.TradeAmt = 'TMoney' #银行余额, double
        self.UseAmt = 'TMoney' #银行可用余额, double
        self.FetchAmt = 'TMoney' #银行可取余额, double
        self.CurrencyCode = 'TCurrencyCode' #币种, char[4]
...
class TransferQryDetailRsp(BaseStruct): #查询银行交易明细请求响应
    def __init__(self, TradeDate='', TradeTime='', TradeCode='', FutureSerial=0, FutureID='', FutureAccount='', BankSerial=0, BankID='', BankBrchID='', BankAccount='', CertCode='', CurrencyCode='', TxAmount=0.0, Flag=''):
        self.TradeDate = 'TDate' #交易日期, char[9]
        self.TradeTime = 'TTradeTime' #交易时间, char[9]
        self.TradeCode = 'TTradeCode' #交易代码, char[7]
        self.FutureSerial = 'TTradeSerialNo' #期货流水号, int
        self.FutureID = 'TFutureID' #期货公司代码, char[11]
        self.FutureAccount = 'TFutureAccount' #资金帐号, char[22]
        self.BankSerial = 'TTradeSerialNo' #银行流水号, int
        self.BankID = 'TBankID' #银行代码, char[4]
        self.BankBrchID = 'TBankBrchID' #银行分中心代码, char[5]
        self.BankAccount = 'TBankAccount' #银行账号, char[41]
        self.CertCode = 'TCertCode' #证件号码, char[21]
        self.CurrencyCode = 'TCurrencyCode' #货币代码, char[4]
        self.TxAmount = 'TMoney' #发生金额, double
        self.Flag = 'TTransferValidFlag' #有效标志, char
...
class Exchange(BaseStruct): #交易所
    def __init__(self, ExchangeID='', ExchangeName='', ExchangeProperty=''):
        ...
        self.ExchangeName = 'TExchangeName' #交易所名称, char[31]
        self.ExchangeProperty = 'TExchangeProperty' #交易所属性, char
...
class Product(BaseStruct): #产品
    def __init__(self, ProductID='', ProductName='', ExchangeID='', ProductClass='', VolumeMultiple=0, PriceTick=0.0, MaxMarketOrderVolume=0, MinMarketOrderVolume=0, MaxLimitOrderVolume=0, MinLimitOrderVolume=0, PositionType='', PositionDateType='', CloseDealType=''):
        self.ProductID = 'TInstrumentID' #产品代码, char[31]
        self.ProductName = 'TProductName' #产品名称, char[21]
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.ProductClass = 'TProductClass' #产品类型, char
        self.VolumeMultiple = 'TVolumeMultiple' #合约数量乘数, int
        self.PriceTick = 'TPrice' #最小变动价位, double
        self.MaxMarketOrderVolume = 'TVolume' #市价单最大下单量, int
        self.MinMarketOrderVolume = 'TVolume' #市价单最小下单量, int
        self.MaxLimitOrderVolume = 'TVolume' #限价单最大下单量, int
        self.MinLimitOrderVolume = 'TVolume' #限价单最小下单量, int
        self.PositionType = 'TPositionType' #持仓类型, char
        self.PositionDateType = 'TPositionDateType' #持仓日期类型, char
        self.CloseDealType = 'TCloseDealType' #平仓处理类型, char
...
class Instrument(BaseStruct): #合约
    def __init__(self, InstrumentID='', ExchangeID='', InstrumentName='', ExchangeInstID='', ProductID='', ProductClass='', DeliveryYear=0, DeliveryMonth=0, MaxMarketOrderVolume=0, MinMarketOrderVolume=0, MaxLimitOrderVolume=0, MinLimitOrderVolume=0, VolumeMultiple=0, PriceTick=0.0, CreateDate='', OpenDate='', ExpireDate='', StartDelivDate='', EndDelivDate='', InstLifePhase='', IsTrading=0, PositionType='', PositionDateType='', LongMarginRatio=0.0, ShortMarginRatio=0.0):
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.InstrumentName = 'TInstrumentName' #合约名称, char[21]
        self.ExchangeInstID = 'TExchangeInstID' #合约在交易所的代码, char[31]
        self.ProductID = 'TInstrumentID' #产品代码, char[31]
        self.ProductClass = 'TProductClass' #产品类型, char
        self.DeliveryYear = 'TYear' #交割年份, int
        self.DeliveryMonth = 'TMonth' #交割月, int
        self.MaxMarketOrderVolume = 'TVolume' #市价单最大下单量, int
        self.MinMarketOrderVolume = 'TVolume' #市价单最小下单量, int
        self.MaxLimitOrderVolume = 'TVolume' #限价单最大下单量, int
        self.MinLimitOrderVolume = 'TVolume' #限价单最小下单量, int
        self.VolumeMultiple = 'TVolumeMultiple' #合约数量乘数, int
        self.PriceTick = 'TPrice' #最小变动价位, double
        self.CreateDate = 'TDate' #创建日, char[9]
        self.OpenDate = 'TDate' #上市日, char[9]
        self.ExpireDate = 'TDate' #到期日, char[9]
        self.StartDelivDate = 'TDate' #开始交割日, char[9]
        self.EndDelivDate = 'TDate' #结束交割日, char[9]
        self.InstLifePhase = 'TInstLifePhase' #合约生命周期状态, char
        self.IsTrading = 'TBool' #当前是否交易, int
        self.PositionType = 'TPositionType' #持仓类型, char
        self.PositionDateType = 'TPositionDateType' #持仓日期类型, char
        self.LongMarginRatio = 'TRatio' #多头保证金率, double
        self.ShortMarginRatio = 'TRatio' #空头保证金率, double

class Broker(BaseStruct): #经纪公司
    def __init__(self, BrokerID='', BrokerAbbr='', BrokerName='', IsActive=0):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.BrokerAbbr = 'TBrokerAbbr' #经纪公司简称, char[9]
        self.BrokerName = 'TBrokerName' #经纪公司名称, char[81]
        self.IsActive = 'TBool' #是否活跃, int

class Trader(BaseStruct): #交易所交易员
    def __init__(self, ExchangeID='', TraderID='', ParticipantID='', Password='', InstallCount=0, BrokerID=''):
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.TraderID = 'TTraderID' #交易所交易员代码, char[21]
        self.ParticipantID = 'TParticipantID' #会员代码, char[11]
        self.Password = 'TPassword' #密码, char[41]
        self.InstallCount = 'TInstallCount' #安装数量, int
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
...
class Investor(BaseStruct): #投资者
    def __init__(self, InvestorID='', BrokerID='', InvestorGroupID='', InvestorName='', IdentifiedCardType='', IdentifiedCardNo='', IsActive=0, Telephone='', Address='', OpenDate='', Mobile='', CommModelID='', MarginModelID=''):
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorGroupID = 'TInvestorID' #投资者分组代码, char[13]
        self.InvestorName = 'TPartyName' #投资者名称, char[81]
        self.IdentifiedCardType = 'TIdCardType' #证件类型, char
        self.IdentifiedCardNo = 'TIdentifiedCardNo' #证件号码, char[51]
        self.IsActive = 'TBool' #是否活跃, int
        self.Telephone = 'TTelephone' #联系电话, char[41]
        self.Address = 'TAddress' #通讯地址, char[101]
        self.OpenDate = 'TDate' #开户日期, char[9]
        self.Mobile = 'TMobile' #手机, char[41]
        self.CommModelID = 'TInvestorID' #手续费率模板代码, char[13]
        self.MarginModelID = 'TInvestorID' #保证金率模板代码, char[13]
...
class TradingCode(BaseStruct): #交易编码
    def __init__(self, InvestorID='', BrokerID='', ExchangeID='', ClientID='', IsActive=0, ClientIDType=''):
        ...
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.ClientID = 'TClientID' #客户代码, char[11]
        self.IsActive = 'TBool' #是否活跃, int
        self.ClientIDType = 'TClientIDType' #交易编码类型, char
...
class SuperUserFunction(BaseStruct): #管理用户功能权限
    def __init__(self, UserID='', FunctionCode=''):
        self.UserID = 'TUserID' #用户代码, char[16]
        self.FunctionCode = 'TFunctionCode' #功能代码, char

class InvestorGroup(BaseStruct): #投资者组
    def __init__(self, BrokerID='', InvestorGroupID='', InvestorGroupName=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorGroupID = 'TInvestorID' #投资者分组代码, char[13]
        self.InvestorGroupName = 'TInvestorGroupName' #投资者分组名称, char[41]
...
class TradingAccount(BaseStruct): #资金账户
    def __init__(self, BrokerID='', AccountID='', PreMortgage=0.0, PreCredit=0.0, PreDeposit=0.0, PreBalance=0.0, PreMargin=0.0, InterestBase=0.0, Interest=0.0, Deposit=0.0, Withdraw=0.0, FrozenMargin=0.0, FrozenCash=0.0, FrozenCommission=0.0, CurrMargin=0.0, CashIn=0.0, Commission=0.0, CloseProfit=0.0, PositionProfit=0.0, Balance=0.0, Available=0.0, WithdrawQuota=0.0, Reserve=0.0, TradingDay='', SettlementID=0, Credit=0.0, Mortgage=0.0, ExchangeMargin=0.0, DeliveryMargin=0.0, ExchangeDeliveryMargin=0.0):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.AccountID = 'TAccountID' #投资者帐号, char[13]
        self.PreMortgage = 'TMoney' #上次质押金额, double
        self.PreCredit = 'TMoney' #上次信用额度, double
        self.PreDeposit = 'TMoney' #上次存款额, double
        self.PreBalance = 'TMoney' #上次结算准备金, double
        self.PreMargin = 'TMoney' #上次占用的保证金, double
        self.InterestBase = 'TMoney' #利息基数, double
        self.Interest = 'TMoney' #利息收入, double
        self.Deposit = 'TMoney' #入金金额, double
        self.Withdraw = 'TMoney' #出金金额, double
        self.FrozenMargin = 'TMoney' #冻结的保证金, double
        self.FrozenCash = 'TMoney' #冻结的资金, double
        self.FrozenCommission = 'TMoney' #冻结的手续费, double
        self.CurrMargin = 'TMoney' #当前保证金总额, double
        self.CashIn = 'TMoney' #资金差额, double
        self.Commission = 'TMoney' #手续费, double
        self.CloseProfit = 'TMoney' #平仓盈亏, double
        self.PositionProfit = 'TMoney' #持仓盈亏, double
        self.Balance = 'TMoney' #期货结算准备金, double
        self.Available = 'TMoney' #可用资金, double
        self.WithdrawQuota = 'TMoney' #可取资金, double
        self.Reserve = 'TMoney' #基本准备金, double
        self.TradingDay = 'TDate' #交易日, char[9]
        self.SettlementID = 'TSettlementID' #结算编号, int
        self.Credit = 'TMoney' #信用额度, double
        self.Mortgage = 'TMoney' #质押金额, double
        self.ExchangeMargin = 'TMoney' #交易所保证金, double
        self.DeliveryMargin = 'TMoney' #投资者交割保证金, double
        self.ExchangeDeliveryMargin = 'TMoney' #交易所交割保证金, double
...
class InvestorPosition(BaseStruct): #投资者持仓
    def __init__(self, InstrumentID='', BrokerID='', InvestorID='', PosiDirection='', HedgeFlag='', PositionDate='', YdPosition=0, Position=0, LongFrozen=0, ShortFrozen=0, LongFrozenAmount=0.0, ShortFrozenAmount=0.0, OpenVolume=0, CloseVolume=0, OpenAmount=0.0, CloseAmount=0.0, PositionCost=0.0, PreMargin=0.0, UseMargin=0.0, FrozenMargin=0.0, FrozenCash=0.0, FrozenCommission=0.0, CashIn=0.0, Commission=0.0, CloseProfit=0.0, PositionProfit=0.0, PreSettlementPrice=0.0, SettlementPrice=0.0, TradingDay='', SettlementID=0, OpenCost=0.0, ExchangeMargin=0.0, CombPosition=0, CombLongFrozen=0, CombShortFrozen=0, CloseProfitByDate=0.0, CloseProfitByTrade=0.0, TodayPosition=0, MarginRateByMoney=0.0, MarginRateByVolume=0.0):
        ...
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.PosiDirection = 'TPosiDirection' #持仓多空方向, char
        self.HedgeFlag = 'THedgeFlag' #投机套保标志, char
        self.PositionDate = 'TPositionDate' #持仓日期, char
        self.YdPosition = 'TVolume' #上日持仓, int
        self.Position = 'TVolume' #今日持仓, int
        self.LongFrozen = 'TVolume' #多头冻结, int
        self.ShortFrozen = 'TVolume' #空头冻结, int
        self.LongFrozenAmount = 'TMoney' #开仓冻结金额, double
        self.ShortFrozenAmount = 'TMoney' #开仓冻结金额, double
        self.OpenVolume = 'TVolume' #开仓量, int
        self.CloseVolume = 'TVolume' #平仓量, int
        self.OpenAmount = 'TMoney' #开仓金额, double
        self.CloseAmount = 'TMoney' #平仓金额, double
        self.PositionCost = 'TMoney' #持仓成本, double
        self.PreMargin = 'TMoney' #上次占用的保证金, double
        self.UseMargin = 'TMoney' #占用的保证金, double
        self.FrozenMargin = 'TMoney' #冻结的保证金, double
        self.FrozenCash = 'TMoney' #冻结的资金, double
        self.FrozenCommission = 'TMoney' #冻结的手续费, double
        self.CashIn = 'TMoney' #资金差额, double
        ...
        self.CloseProfit = 'TMoney' #平仓盈亏, double
        self.PositionProfit = 'TMoney' #持仓盈亏, double
        self.PreSettlementPrice = 'TPrice' #上次结算价, double
        self.SettlementPrice = 'TPrice' #本次结算价, double
        self.TradingDay = 'TDate' #交易日, char[9]
        self.SettlementID = 'TSettlementID' #结算编号, int
        self.OpenCost = 'TMoney' #开仓成本, double
        self.ExchangeMargin = 'TMoney' #交易所保证金, double
        self.CombPosition = 'TVolume' #组合成交形成的持仓, int
        self.CombLongFrozen = 'TVolume' #组合多头冻结, int
        self.CombShortFrozen = 'TVolume' #组合空头冻结, int
        self.CloseProfitByDate = 'TMoney' #逐日盯市平仓盈亏, double
        self.CloseProfitByTrade = 'TMoney' #逐笔对冲平仓盈亏, double
        self.TodayPosition = 'TVolume' #今日持仓, int
        self.MarginRateByMoney = 'TRatio' #保证金率, double
        self.MarginRateByVolume = 'TRatio' #保证金率(按手数), double
...
class InstrumentMarginRate(BaseStruct): #合约保证金率
    def __init__(self, InstrumentID='', InvestorRange='', BrokerID='', InvestorID='', HedgeFlag='', LongMarginRatioByMoney=0.0, LongMarginRatioByVolume=0.0, ShortMarginRatioByMoney=0.0, ShortMarginRatioByVolume=0.0, IsRelative=0):
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
        self.InvestorRange = 'TInvestorRange' #投资者范围, char
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.HedgeFlag = 'THedgeFlag' #投机套保标志, char
        self.LongMarginRatioByMoney = 'TRatio' #多头保证金率, double
        self.LongMarginRatioByVolume = 'TMoney' #多头保证金费, double
        self.ShortMarginRatioByMoney = 'TRatio' #空头保证金率, double
        self.ShortMarginRatioByVolume = 'TMoney' #空头保证金费, double
        self.IsRelative = 'TBool' #是否相对交易所收取, int
...
class InstrumentCommissionRate(BaseStruct): #合约手续费率
    def __init__(self, InstrumentID='', InvestorRange='', BrokerID='', InvestorID='', OpenRatioByMoney=0.0, OpenRatioByVolume=0.0, CloseRatioByMoney=0.0, CloseRatioByVolume=0.0, CloseTodayRatioByMoney=0.0, CloseTodayRatioByVolume=0.0):
        ...
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.OpenRatioByMoney = 'TRatio' #开仓手续费率, double
        self.OpenRatioByVolume = 'TRatio' #开仓手续费, double
        self.CloseRatioByMoney = 'TRatio' #平仓手续费率, double
        self.CloseRatioByVolume = 'TRatio' #平仓手续费, double
        self.CloseTodayRatioByMoney = 'TRatio' #平今手续费率, double
        self.CloseTodayRatioByVolume = 'TRatio' #平今手续费, double
...
class DepthMarketData(BaseStruct): #深度行情
    def __init__(self, TradingDay='', InstrumentID='', ExchangeID='', ExchangeInstID='', LastPrice=0.0, PreSettlementPrice=0.0, PreClosePrice=0.0, PreOpenInterest=0.0, OpenPrice=0.0, HighestPrice=0.0, LowestPrice=0.0, Volume=0, Turnover=0.0, OpenInterest=0.0, ClosePrice=0.0, SettlementPrice=0.0, UpperLimitPrice=0.0, LowerLimitPrice=0.0, PreDelta=0.0, CurrDelta=0.0, UpdateTime='', UpdateMillisec=0, BidPrice1=0.0, BidVolume1=0, AskPrice1=0.0, AskVolume1=0, BidPrice2=0.0, BidVolume2=0, AskPrice2=0.0, AskVolume2=0, BidPrice3=0.0, BidVolume3=0, AskPrice3=0.0, AskVolume3=0, BidPrice4=0.0, BidVolume4=0, AskPrice4=0.0, AskVolume4=0, BidPrice5=0.0, BidVolume5=0, AskPrice5=0.0, AskVolume5=0, AveragePrice=0.0, ActionDay=''):
        ...
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.ExchangeInstID = 'TExchangeInstID' #合约在交易所的代码, char[31]
        self.LastPrice = 'TPrice' #最新价, double
        self.PreSettlementPrice = 'TPrice' #上次结算价, double
        self.PreClosePrice = 'TPrice' #昨收盘, double
        self.PreOpenInterest = 'TLargeVolume' #昨持仓量, double
        self.OpenPrice = 'TPrice' #今开盘, double
        self.HighestPrice = 'TPrice' #最高价, double
        self.LowestPrice = 'TPrice' #最低价, double
        self.Volume = 'TVolume' #数量, int
        self.Turnover = 'TMoney' #成交金额, double
        self.OpenInterest = 'TLargeVolume' #持仓量, double
        self.ClosePrice = 'TPrice' #今收盘, double
        self.SettlementPrice = 'TPrice' #本次结算价, double
        self.UpperLimitPrice = 'TPrice' #涨停板价, double
        self.LowerLimitPrice = 'TPrice' #跌停板价, double
        self.PreDelta = 'TRatio' #昨虚实度, double
        self.CurrDelta = 'TRatio' #今虚实度, double
        self.UpdateTime = 'TTime' #最后修改时间, char[9]
        self.UpdateMillisec = 'TMillisec' #最后修改毫秒, int
        self.BidPrice1 = 'TPrice' #申买价一, double
        self.BidVolume1 = 'TVolume' #申买量一, int
        self.AskPrice1 = 'TPrice' #申卖价一, double
        self.AskVolume1 = 'TVolume' #申卖量一, int
        self.BidPrice2 = 'TPrice' #申买价二, double
        self.BidVolume2 = 'TVolume' #申买量二, int
        self.AskPrice2 = 'TPrice' #申卖价二, double
        self.AskVolume2 = 'TVolume' #申卖量二, int
        self.BidPrice3 = 'TPrice' #申买价三, double
        self.BidVolume3 = 'TVolume' #申买量三, int
        self.AskPrice3 = 'TPrice' #申卖价三, double
        self.AskVolume3 = 'TVolume' #申卖量三, int
        self.BidPrice4 = 'TPrice' #申买价四, double
        self.BidVolume4 = 'TVolume' #申买量四, int
        self.AskPrice4 = 'TPrice' #申卖价四, double
        self.AskVolume4 = 'TVolume' #申卖量四, int
        self.BidPrice5 = 'TPrice' #申买价五, double
        self.BidVolume5 = 'TVolume' #申买量五, int
        self.AskPrice5 = 'TPrice' #申卖价五, double
        self.AskVolume5 = 'TVolume' #申卖量五, int
        self.AveragePrice = 'TPrice' #当日均价, double
        self.ActionDay = 'TDate' #业务日期, char[9]
...
class InstrumentTradingRight(BaseStruct): #投资者合约交易权限
    def __init__(self, InstrumentID='', InvestorRange='', BrokerID='', InvestorID='', TradingRight=''):
        ...
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.TradingRight = 'TTradingRight' #交易权限, char
...
class BrokerUser(BaseStruct): #经纪公司用户
    def __init__(self, BrokerID='', UserID='', UserName='', UserType='', IsActive=0, IsUsingOTP=0):
        ...
        self.UserID = 'TUserID' #用户代码, char[16]
        self.UserName = 'TUserName' #用户名称, char[81]
        self.UserType = 'TUserType' #用户类型, char
        self.IsActive = 'TBool' #是否活跃, int
        self.IsUsingOTP = 'TBool' #是否使用令牌, int
...
class BrokerUserFunction(BaseStruct): #经纪公司用户功能权限
    def __init__(self, BrokerID='', UserID='', BrokerFunctionCode=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.UserID = 'TUserID' #用户代码, char[16]
        self.BrokerFunctionCode = 'TBrokerFunctionCode' #经纪公司功能代码, char
...
class TraderOffer(BaseStruct): #交易所交易员报盘机
    def __init__(self, ExchangeID='', TraderID='', ParticipantID='', Password='', InstallID=0, OrderLocalID='', TraderConnectStatus='', ConnectRequestDate='', ConnectRequestTime='', LastReportDate='', LastReportTime='', ConnectDate='', ConnectTime='', StartDate='', StartTime='', TradingDay='', BrokerID='', MaxTradeID='', MaxOrderMessageReference=''):
        ...
        self.ParticipantID = 'TParticipantID' #会员代码, char[11]
        self.Password = 'TPassword' #密码, char[41]
        self.InstallID = 'TInstallID' #安装编号, int
        self.OrderLocalID = 'TOrderLocalID' #本地报单编号, char[13]
        self.TraderConnectStatus = 'TTraderConnectStatus' #交易所交易员连接状态, char
        self.ConnectRequestDate = 'TDate' #发出连接请求的日期, char[9]
        self.ConnectRequestTime = 'TTime' #发出连接请求的时间, char[9]
        self.LastReportDate = 'TDate' #上次报告日期, char[9]
        self.LastReportTime = 'TTime' #上次报告时间, char[9]
        self.ConnectDate = 'TDate' #完成连接日期, char[9]
        self.ConnectTime = 'TTime' #完成连接时间, char[9]
        self.StartDate = 'TDate' #启动日期, char[9]
        self.StartTime = 'TTime' #启动时间, char[9]
        self.TradingDay = 'TDate' #交易日, char[9]
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.MaxTradeID = 'TTradeID' #本席位最大成交编号, char[21]
        self.MaxOrderMessageReference = 'TReturnCode' #本席位最大报单备拷, char[7]
...
class SettlementInfo(BaseStruct): #投资者结算结果
    def __init__(self, TradingDay='', SettlementID=0, BrokerID='', InvestorID='', SequenceNo=0, Content=''):
        ...
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.SequenceNo = 'TSequenceNo' #序号, int
        self.Content = 'TContent' #消息正文, char[501]
...
class ExchangeMarginRateAdjust(BaseStruct): #交易所保证金率调整
    def __init__(self, BrokerID='', InstrumentID='', HedgeFlag='', LongMarginRatioByMoney=0.0, LongMarginRatioByVolume=0.0, ShortMarginRatioByMoney=0.0, ShortMarginRatioByVolume=0.0, ExchLongMarginRatioByMoney=0.0, ExchLongMarginRatioByVolume=0.0, ExchShortMarginRatioByMoney=0.0, ExchShortMarginRatioByVolume=0.0, NoLongMarginRatioByMoney=0.0, NoLongMarginRatioByVolume=0.0, NoShortMarginRatioByMoney=0.0, NoShortMarginRatioByVolume=0.0):
        ...
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
        self.HedgeFlag = 'THedgeFlag' #投机套保标志, char
        self.LongMarginRatioByMoney = 'TRatio' #跟随交易所投资者多头保证金率, double
        self.LongMarginRatioByVolume = 'TMoney' #跟随交易所投资者多头保证金费, double
        self.ShortMarginRatioByMoney = 'TRatio' #跟随交易所投资者空头保证金率, double
        self.ShortMarginRatioByVolume = 'TMoney' #跟随交易所投资者空头保证金费, double
        self.ExchLongMarginRatioByMoney = 'TRatio' #交易所多头保证金率, double
        self.ExchLongMarginRatioByVolume = 'TMoney' #交易所多头保证金费, double
        self.ExchShortMarginRatioByMoney = 'TRatio' #交易所空头保证金率, double
        self.ExchShortMarginRatioByVolume = 'TMoney' #交易所空头保证金费, double
        self.NoLongMarginRatioByMoney = 'TRatio' #不跟随交易所投资者多头保证金率, double
        self.NoLongMarginRatioByVolume = 'TMoney' #不跟随交易所投资者多头保证金费, double
        self.NoShortMarginRatioByMoney = 'TRatio' #不跟随交易所投资者空头保证金率, double
        self.NoShortMarginRatioByVolume = 'TMoney' #不跟随交易所投资者空头保证金费, double
...
class CurrentTime(BaseStruct): #当前时间
    def __init__(self, CurrDate='', CurrTime='', CurrMillisec=0, ActionDay=''):
        self.CurrDate = 'TDate' #当前日期, char[9]
        self.CurrTime = 'TTime' #当前时间, char[9]
        self.CurrMillisec = 'TMillisec' #当前时间（毫秒）, int
        self.ActionDay = 'TDate' #业务日期, char[9]

class CommPhase(BaseStruct): #通讯阶段
    def __init__(self, TradingDay='', CommPhaseNo=0, SystemID=''):
        self.TradingDay = 'TDate' #交易日, char[9]
        self.CommPhaseNo = 'TCommPhaseNo' #通讯时段编号, short
        self.SystemID = 'TSystemID' #系统编号, char[21]
...
class LoginInfo(BaseStruct): #登录信息
    def __init__(self, FrontID=0, SessionID=0, BrokerID='', UserID='', LoginDate='', LoginTime='', IPAddress='', UserProductInfo='', InterfaceProductInfo='', ProtocolInfo='', SystemName='', Password='', MaxOrderRef='', SHFETime='', DCETime='', CZCETime='', FFEXTime='', MacAddress='', OneTimePassword=''):
        ...
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.UserID = 'TUserID' #用户代码, char[16]
        self.LoginDate = 'TDate' #登录日期, char[9]
        self.LoginTime = 'TTime' #登录时间, char[9]
        self.IPAddress = 'TIPAddress' #IP地址, char[16]
        self.UserProductInfo = 'TProductInfo' #用户端产品信息, char[11]
        self.InterfaceProductInfo = 'TProductInfo' #接口端产品信息, char[11]
        self.ProtocolInfo = 'TProtocolInfo' #协议信息, char[11]
        self.SystemName = 'TSystemName' #系统名称, char[41]
        self.Password = 'TPassword' #密码, char[41]
        self.MaxOrderRef = 'TOrderRef' #最大报单引用, char[13]
        self.SHFETime = 'TTime' #上期所时间, char[9]
        self.DCETime = 'TTime' #大商所时间, char[9]
...
class UserPasswordUpdate(BaseStruct): #用户口令变更
    def __init__(self, BrokerID='', UserID='', OldPassword='', NewPassword=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.UserID = 'TUserID' #用户代码, char[16]
        self.OldPassword = 'TPassword' #原来的口令, char[41]
        self.NewPassword = 'TPassword' #新的口令, char[41]
...
class InputOrder(BaseStruct): #输入报单
    def __init__(self, BrokerID='', InvestorID='', InstrumentID='', OrderRef='', UserID='', OrderPriceType='', Direction='', CombOffsetFlag='', CombHedgeFlag='', LimitPrice=0.0, VolumeTotalOriginal=0, TimeCondition='', GTDDate='', VolumeCondition='', MinVolume=0, ContingentCondition='', StopPrice=0.0, ForceCloseReason='', IsAutoSuspend=0, BusinessUnit='', RequestID=0, UserForceClose=0, IsSwapOrder=0):
        ...
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
        self.OrderRef = 'TOrderRef' #报单引用, char[13]
        self.UserID = 'TUserID' #用户代码, char[16]
        self.OrderPriceType = 'TOrderPriceType' #报单价格条件, char
        self.Direction = 'TDirection' #买卖方向, char
        self.CombOffsetFlag = 'TCombOffsetFlag' #组合开平标志, char[5]
        self.CombHedgeFlag = 'TCombHedgeFlag' #组合投机套保标志, char[5]
        self.LimitPrice = 'TPrice' #价格, double
        self.VolumeTotalOriginal = 'TVolume' #数量, int
        self.TimeCondition = 'TTimeCondition' #有效期类型, char
        self.GTDDate = 'TDate' #GTD日期, char[9]
        self.VolumeCondition = 'TVolumeCondition' #成交量类型, char
        self.MinVolume = 'TVolume' #最小成交量, int
        self.ContingentCondition = 'TContingentCondition' #触发条件, char
        self.StopPrice = 'TPrice' #止损价, double
        self.ForceCloseReason = 'TForceCloseReason' #强平原因, char
        self.IsAutoSuspend = 'TBool' #自动挂起标志, int
        self.BusinessUnit = 'TBusinessUnit' #业务单元, char[21]
        self.RequestID = 'TRequestID' #请求编号, int
        self.UserForceClose = 'TBool' #用户强评标志, int
        self.IsSwapOrder = 'TBool' #互换单标志, int
...
class Order(BaseStruct): #报单
    def __init__(self, BrokerID='', InvestorID='', InstrumentID='', OrderRef='', UserID='', OrderPriceType='', Direction='', CombOffsetFlag='', CombHedgeFlag='', LimitPrice=0.0, VolumeTotalOriginal=0, TimeCondition='', GTDDate='', VolumeCondition='', MinVolume=0, ContingentCondition='', StopPrice=0.0, ForceCloseReason='', IsAutoSuspend=0, BusinessUnit='', RequestID=0, OrderLocalID='', ExchangeID='', ParticipantID='', ClientID='', ExchangeInstID='', TraderID='', InstallID=0, OrderSubmitStatus='', NotifySequence=0, TradingDay='', SettlementID=0, OrderSysID='', OrderSource='', OrderStatus='', OrderType='', VolumeTraded=0, VolumeTotal=0, InsertDate='', InsertTime='', ActiveTime='', SuspendTime='', UpdateTime='', CancelTime='', ActiveTraderID='', ClearingPartID='', SequenceNo=0, FrontID=0, SessionID=0, UserProductInfo='', StatusMsg='', UserForceClose=0, ActiveUserID='', BrokerOrderSeq=0, RelativeOrderSysID='', ZCETotalTradedVolume=0, IsSwapOrder=0):
        ...
        self.TraderID = 'TTraderID' #交易所交易员代码, char[21]
        self.InstallID = 'TInstallID' #安装编号, int
        self.OrderSubmitStatus = 'TOrderSubmitStatus' #报单提交状态, char
        self.NotifySequence = 'TSequenceNo' #报单提示序号, int
        self.TradingDay = 'TDate' #交易日, char[9]
        self.SettlementID = 'TSettlementID' #结算编号, int
        self.OrderSysID = 'TOrderSysID' #报单编号, char[21]
        self.OrderSource = 'TOrderSource' #报单来源, char
        self.OrderStatus = 'TOrderStatus' #报单状态, char
        self.OrderType = 'TOrderType' #报单类型, char
        self.VolumeTraded = 'TVolume' #今成交数量, int
        self.VolumeTotal = 'TVolume' #剩余数量, int
        self.InsertDate = 'TDate' #报单日期, char[9]
        self.InsertTime = 'TTime' #委托时间, char[9]
        self.ActiveTime = 'TTime' #激活时间, char[9]
        self.SuspendTime = 'TTime' #挂起时间, char[9]
        self.UpdateTime = 'TTime' #最后修改时间, char[9]
        self.CancelTime = 'TTime' #撤销时间, char[9]
        self.ActiveTraderID = 'TTraderID' #最后修改交易所交易员代码, char[21]
        self.ClearingPartID = 'TParticipantID' #结算会员编号, char[11]
        self.SequenceNo = 'TSequenceNo' #序号, int
        self.FrontID = 'TFrontID' #前置编号, int
        self.SessionID = 'TSessionID' #会话编号, int
        self.UserProductInfo = 'TProductInfo' #用户端产品信息, char[11]
        self.StatusMsg = 'TErrorMsg' #状态信息, char[81]
        self.UserForceClose = 'TBool' #用户强评标志, int
        self.ActiveUserID = 'TUserID' #操作用户代码, char[16]
        self.BrokerOrderSeq = 'TSequenceNo' #经纪公司报单编号, int
        self.RelativeOrderSysID = 'TOrderSysID' #相关报单, char[21]
        self.ZCETotalTradedVolume = 'TVolume' #郑商所成交数量, int
        self.IsSwapOrder = 'TBool' #互换单标志, int
...
class InputOrderAction(BaseStruct): #输入报单操作
    def __init__(self, BrokerID='', InvestorID='', OrderActionRef=0, OrderRef='', RequestID=0, FrontID=0, SessionID=0, ExchangeID='', OrderSysID='', ActionFlag='', LimitPrice=0.0, VolumeChange=0, UserID='', InstrumentID=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.OrderActionRef = 'TOrderActionRef' #报单操作引用, int
        self.OrderRef = 'TOrderRef' #报单引用, char[13]
        self.RequestID = 'TRequestID' #请求编号, int
        self.FrontID = 'TFrontID' #前置编号, int
        self.SessionID = 'TSessionID' #会话编号, int
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.OrderSysID = 'TOrderSysID' #报单编号, char[21]
        self.ActionFlag = 'TActionFlag' #操作标志, char
        self.LimitPrice = 'TPrice' #价格, double
        self.VolumeChange = 'TVolume' #数量变化, int
        self.UserID = 'TUserID' #用户代码, char[16]
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
...
class OrderAction(BaseStruct): #报单操作
    def __init__(self, BrokerID='', InvestorID='', OrderActionRef=0, OrderRef='', RequestID=0, FrontID=0, SessionID=0, ExchangeID='', OrderSysID='', ActionFlag='', LimitPrice=0.0, VolumeChange=0, ActionDate='', ActionTime='', TraderID='', InstallID=0, OrderLocalID='', ActionLocalID='', ParticipantID='', ClientID='', BusinessUnit='', OrderActionStatus='', UserID='', StatusMsg='', InstrumentID=''):
        ...
        self.LimitPrice = 'TPrice' #价格, double
        self.VolumeChange = 'TVolume' #数量变化, int
        self.ActionDate = 'TDate' #操作日期, char[9]
        self.ActionTime = 'TTime' #操作时间, char[9]
        self.TraderID = 'TTraderID' #交易所交易员代码, char[21]
        self.InstallID = 'TInstallID' #安装编号, int
        self.OrderLocalID = 'TOrderLocalID' #本地报单编号, char[13]
        self.ActionLocalID = 'TOrderLocalID' #操作本地编号, char[13]
        self.ParticipantID = 'TParticipantID' #会员代码, char[11]
        self.ClientID = 'TClientID' #客户代码, char[11]
        self.BusinessUnit = 'TBusinessUnit' #业务单元, char[21]
        self.OrderActionStatus = 'TOrderActionStatus' #报单操作状态, char
        self.UserID = 'TUserID' #用户代码, char[16]
        self.StatusMsg = 'TErrorMsg' #状态信息, char[81]
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
...
class ExchangeTrade(BaseStruct): #交易所成交
    def __init__(self, ExchangeID='', TradeID='', Direction='', OrderSysID='', ParticipantID='', ClientID='', TradingRole='', ExchangeInstID='', OffsetFlag='', HedgeFlag='', Price=0.0, Volume=0, TradeDate='', TradeTime='', TradeType='', PriceSource='', TraderID='', OrderLocalID='', ClearingPartID='', BusinessUnit='', SequenceNo=0, TradeSource=''):
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.TradeID = 'TTradeID' #成交编号, char[21]
        self.Direction = 'TDirection' #买卖方向, char
        self.OrderSysID = 'TOrderSysID' #报单编号, char[21]
        self.ParticipantID = 'TParticipantID' #会员代码, char[11]
        self.ClientID = 'TClientID' #客户代码, char[11]
        self.TradingRole = 'TTradingRole' #交易角色, char
        self.ExchangeInstID = 'TExchangeInstID' #合约在交易所的代码, char[31]
        self.OffsetFlag = 'TOffsetFlag' #开平标志, char
        self.HedgeFlag = 'THedgeFlag' #投机套保标志, char
        self.Price = 'TPrice' #价格, double
        self.Volume = 'TVolume' #数量, int
        self.TradeDate = 'TDate' #成交时期, char[9]
        self.TradeTime = 'TTime' #成交时间, char[9]
        self.TradeType = 'TTradeType' #成交类型, char
        self.PriceSource = 'TPriceSource' #成交价来源, char
        self.TraderID = 'TTraderID' #交易所交易员代码, char[21]
        self.OrderLocalID = 'TOrderLocalID' #本地报单编号, char[13]
        self.ClearingPartID = 'TParticipantID' #结算会员编号, char[11]
        self.BusinessUnit = 'TBusinessUnit' #业务单元, char[21]
        self.SequenceNo = 'TSequenceNo' #序号, int
        self.TradeSource = 'TTradeSource' #成交来源, char
...
class QryOrder(BaseStruct): #查询报单
    def __init__(self, BrokerID='', InvestorID='', InstrumentID='', ExchangeID='', OrderSysID='', InsertTimeStart='', InsertTimeEnd=''):
        ...
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.OrderSysID = 'TOrderSysID' #报单编号, char[21]
        self.InsertTimeStart = 'TTime' #开始时间, char[9]
        self.InsertTimeEnd = 'TTime' #结束时间, char[9]
...
class QryTrade(BaseStruct): #查询成交
    def __init__(self, BrokerID='', InvestorID='', InstrumentID='', ExchangeID='', TradeID='', TradeTimeStart='', TradeTimeEnd=''):
        ...
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.TradeID = 'TTradeID' #成交编号, char[21]
        self.TradeTimeStart = 'TTime' #开始时间, char[9]
        self.TradeTimeEnd = 'TTime' #结束时间, char[9]
...
class InstrumentStatus(BaseStruct): #合约状态
    def __init__(self, ExchangeID='', ExchangeInstID='', SettlementGroupID='', InstrumentID='', InstrumentStatus='', TradingSegmentSN=0, EnterTime='', EnterReason=''):
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.ExchangeInstID = 'TExchangeInstID' #合约在交易所的代码, char[31]
        self.SettlementGroupID = 'TSettlementGroupID' #结算组代码, char[9]
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
        self.InstrumentStatus = 'TInstrumentStatus' #合约交易状态, char
        self.TradingSegmentSN = 'TTradingSegmentSN' #交易阶段编号, int
        self.EnterTime = 'TTime' #进入本状态时间, char[9]
        self.EnterReason = 'TInstStatusEnterReason' #进入本状态原因, char
...
class PositionProfitAlgorithm(BaseStruct): #浮动盈亏算法
    def __init__(self, BrokerID='', AccountID='', Algorithm='', Memo=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.AccountID = 'TAccountID' #投资者帐号, char[13]
        self.Algorithm = 'TAlgorithm' #盈亏算法, char
        self.Memo = 'TMemo' #备注, char[161]
...
class Discount(BaseStruct): #会员资金折扣
    def __init__(self, BrokerID='', InvestorRange='', InvestorID='', Discount=0.0):
        ...
        self.InvestorRange = 'TInvestorRange' #投资者范围, char
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.Discount = 'TRatio' #资金折扣比例, double
...
class TransferBank(BaseStruct): #转帐银行
    def __init__(self, BankID='', BankBrchID='', BankName='', IsActive=0):
        self.BankID = 'TBankID' #银行代码, char[4]
        self.BankBrchID = 'TBankBrchID' #银行分中心代码, char[5]
        self.BankName = 'TBankName' #银行名称, char[101]
        self.IsActive = 'TBool' #是否活跃, int
...
class InvestorPositionDetail(BaseStruct): #投资者持仓明细
    def __init__(self, InstrumentID='', BrokerID='', InvestorID='', HedgeFlag='', Direction='', OpenDate='', TradeID='', Volume=0, OpenPrice=0.0, TradingDay='', SettlementID=0, TradeType='', CombInstrumentID='', ExchangeID='', CloseProfitByDate=0.0, CloseProfitByTrade=0.0, PositionProfitByDate=0.0, PositionProfitByTrade=0.0, Margin=0.0, ExchMargin=0.0, MarginRateByMoney=0.0, MarginRateByVolume=0.0, LastSettlementPrice=0.0, SettlementPrice=0.0, CloseVolume=0, CloseAmount=0.0):
        ...
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.HedgeFlag = 'THedgeFlag' #投机套保标志, char
        self.Direction = 'TDirection' #买卖, char
        self.OpenDate = 'TDate' #开仓日期, char[9]
        self.TradeID = 'TTradeID' #成交编号, char[21]
        self.Volume = 'TVolume' #数量, int
        self.OpenPrice = 'TPrice' #开仓价, double
        self.TradingDay = 'TDate' #交易日, char[9]
        self.SettlementID = 'TSettlementID' #结算编号, int
        self.TradeType = 'TTradeType' #成交类型, char
        self.CombInstrumentID = 'TInstrumentID' #组合合约代码, char[31]
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.CloseProfitByDate = 'TMoney' #逐日盯市平仓盈亏, double
        self.CloseProfitByTrade = 'TMoney' #逐笔对冲平仓盈亏, double
        self.PositionProfitByDate = 'TMoney' #逐日盯市持仓盈亏, double
        self.PositionProfitByTrade = 'TMoney' #逐笔对冲持仓盈亏, double
        self.Margin = 'TMoney' #投资者保证金, double
        self.ExchMargin = 'TMoney' #交易所保证金, double
        self.MarginRateByMoney = 'TRatio' #保证金率, double
        self.MarginRateByVolume = 'TRatio' #保证金率(按手数), double
        self.LastSettlementPrice = 'TPrice' #昨结算价, double
        self.SettlementPrice = 'TPrice' #结算价, double
        self.CloseVolume = 'TVolume' #平仓量, int
        self.CloseAmount = 'TMoney' #平仓金额, double
...
class Notice(BaseStruct): #客户通知
    def __init__(self, BrokerID='', Content='', SequenceLabel=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.Content = 'TContent' #消息正文, char[501]
        self.SequenceLabel = 'TSequenceLabel' #经纪公司通知内容序列号, char[2]

class UserRight(BaseStruct): #用户权限
    def __init__(self, BrokerID='', UserID='', UserRightType='', IsForbidden=0):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.UserID = 'TUserID' #用户代码, char[16]
        self.UserRightType = 'TUserRightType' #客户权限类型, char
        self.IsForbidden = 'TBool' #是否禁止, int
...
class BrokerWithdrawAlgorithm(BaseStruct): #经纪公司可提资金算法表
    def __init__(self, BrokerID='', WithdrawAlgorithm='', UsingRatio=0.0, IncludeCloseProfit='', AllWithoutTrade='', AvailIncludeCloseProfit='', IsBrokerUserEvent=0):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.WithdrawAlgorithm = 'TAlgorithm' #可提资金算法, char
        self.UsingRatio = 'TRatio' #资金使用率, double
        self.IncludeCloseProfit = 'TIncludeCloseProfit' #可提是否包含平仓盈利, char
        self.AllWithoutTrade = 'TAllWithoutTrade' #本日无仓且无成交客户是否受可提比例限制, char
        self.AvailIncludeCloseProfit = 'TIncludeCloseProfit' #可用是否包含平仓盈利, char
        self.IsBrokerUserEvent = 'TBool' #是否启用用户事件, int
...
class QryCombinationLeg(BaseStruct): #查询组合合约分腿
    def __init__(self, CombInstrumentID='', LegID=0, LegInstrumentID=''):
        self.CombInstrumentID = 'TInstrumentID' #组合合约代码, char[31]
        self.LegID = 'TLegID' #单腿编号, int
        self.LegInstrumentID = 'TInstrumentID' #单腿合约代码, char[31]
...
class CombinationLeg(BaseStruct): #组合交易合约的单腿
    def __init__(self, CombInstrumentID='', LegID=0, LegInstrumentID='', Direction='', LegMultiple=0, ImplyLevel=0):
        ...
        self.LegInstrumentID = 'TInstrumentID' #单腿合约代码, char[31]
        self.Direction = 'TDirection' #买卖方向, char
        self.LegMultiple = 'TLegMultiple' #单腿乘数, int
        self.ImplyLevel = 'TImplyLevel' #派生层数, int

class SyncStatus(BaseStruct): #数据同步状态
    def __init__(self, TradingDay='', DataSyncStatus=''):
        self.TradingDay = 'TDate' #交易日, char[9]
        self.DataSyncStatus = 'TDataSyncStatus' #数据同步状态, char
...
class LinkMan(BaseStruct): #联系人
    def __init__(self, BrokerID='', InvestorID='', PersonType='', IdentifiedCardType='', IdentifiedCardNo='', PersonName='', Telephone='', Address='', ZipCode='', Priority=0):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.PersonType = 'TPersonType' #联系人类型, char
        self.IdentifiedCardType = 'TIdCardType' #证件类型, char
        self.IdentifiedCardNo = 'TIdentifiedCardNo' #证件号码, char[51]
        self.PersonName = 'TPartyName' #名称, char[81]
        self.Telephone = 'TTelephone' #联系电话, char[41]
        self.Address = 'TAddress' #通讯地址, char[101]
        self.ZipCode = 'TZipCode' #邮政编码, char[7]
        self.Priority = 'TPriority' #优先级, int

class QryBrokerUserEvent(BaseStruct): #查询经纪公司用户事件
    def __init__(self, BrokerID='', UserID='', UserEventType=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.UserID = 'TUserID' #用户代码, char[16]
        self.UserEventType = 'TUserEventType' #用户事件类型, char
...
class BrokerUserEvent(BaseStruct): #查询经纪公司用户事件
    def __init__(self, BrokerID='', UserID='', UserEventType='', EventSequenceNo=0, EventDate='', EventTime='', UserEventInfo='', InvestorID='', InstrumentID=''):
        ...
        self.UserID = 'TUserID' #用户代码, char[16]
        self.UserEventType = 'TUserEventType' #用户事件类型, char
        self.EventSequenceNo = 'TSequenceNo' #用户事件序号, int
        self.EventDate = 'TDate' #事件发生日期, char[9]
        self.EventTime = 'TTime' #事件发生时间, char[9]
        self.UserEventInfo = 'TUserEventInfo' #用户事件信息, char[1025]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
...
class InvestorPositionCombineDetail(BaseStruct): #投资者组合持仓明细
    def __init__(self, TradingDay='', OpenDate='', ExchangeID='', SettlementID=0, BrokerID='', InvestorID='', ComTradeID='', TradeID='', InstrumentID='', HedgeFlag='', Direction='', TotalAmt=0, Margin=0.0, ExchMargin=0.0, MarginRateByMoney=0.0, MarginRateByVolume=0.0, LegID=0, LegMultiple=0, CombInstrumentID=''):
        ...
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.ComTradeID = 'TTradeID' #组合编号, char[21]
        self.TradeID = 'TTradeID' #撮合编号, char[21]
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
        self.HedgeFlag = 'THedgeFlag' #投机套保标志, char
        self.Direction = 'TDirection' #买卖, char
        self.TotalAmt = 'TVolume' #持仓量, int
        self.Margin = 'TMoney' #投资者保证金, double
        self.ExchMargin = 'TMoney' #交易所保证金, double
        self.MarginRateByMoney = 'TRatio' #保证金率, double
        self.MarginRateByVolume = 'TRatio' #保证金率(按手数), double
        self.LegID = 'TLegID' #单腿编号, int
        self.LegMultiple = 'TLegMultiple' #单腿乘数, int
        self.CombInstrumentID = 'TInstrumentID' #组合持仓合约编码, char[31]
...
class ParkedOrder(BaseStruct): #预埋单
    def __init__(self, BrokerID='', InvestorID='', InstrumentID='', OrderRef='', UserID='', OrderPriceType='', Direction='', CombOffsetFlag='', CombHedgeFlag='', LimitPrice=0.0, VolumeTotalOriginal=0, TimeCondition='', GTDDate='', VolumeCondition='', MinVolume=0, ContingentCondition='', StopPrice=0.0, ForceCloseReason='', IsAutoSuspend=0, BusinessUnit='', RequestID=0, UserForceClose=0, ExchangeID='', ParkedOrderID='', UserType='', Status='', ErrorID=0, ErrorMsg='', IsSwapOrder=0):
        ...
        self.UserForceClose = 'TBool' #用户强评标志, int
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.ParkedOrderID = 'TParkedOrderID' #预埋报单编号, char[13]
        self.UserType = 'TUserType' #用户类型, char
        self.Status = 'TParkedOrderStatus' #预埋单状态, char
        self.ErrorID = 'TErrorID' #错误代码, int
        self.ErrorMsg = 'TErrorMsg' #错误信息, char[81]
        self.IsSwapOrder = 'TBool' #互换单标志, int
...
class ParkedOrderAction(BaseStruct): #输入预埋单操作
    def __init__(self, BrokerID='', InvestorID='', OrderActionRef=0, OrderRef='', RequestID=0, FrontID=0, SessionID=0, ExchangeID='', OrderSysID='', ActionFlag='', LimitPrice=0.0, VolumeChange=0, UserID='', InstrumentID='', ParkedOrderActionID='', UserType='', Status='', ErrorID=0, ErrorMsg=''):
        ...
        self.UserID = 'TUserID' #用户代码, char[16]
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
        self.ParkedOrderActionID = 'TParkedOrderActionID' #预埋撤单单编号, char[13]
        self.UserType = 'TUserType' #用户类型, char
        self.Status = 'TParkedOrderStatus' #预埋撤单状态, char
        self.ErrorID = 'TErrorID' #错误代码, int
        self.ErrorMsg = 'TErrorMsg' #错误信息, char[81]
...
class RemoveParkedOrderAction(BaseStruct): #删除预埋撤单
    def __init__(self, BrokerID='', InvestorID='', ParkedOrderActionID=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.ParkedOrderActionID = 'TParkedOrderActionID' #预埋撤单编号, char[13]
...
class InvestorWithdrawAlgorithm(BaseStruct): #经纪公司可提资金算法表
    def __init__(self, BrokerID='', InvestorRange='', InvestorID='', UsingRatio=0.0):
        ...
        self.InvestorRange = 'TInvestorRange' #投资者范围, char
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.UsingRatio = 'TRatio' #可提资金比例, double
...
class UserIP(BaseStruct): #用户IP
    def __init__(self, BrokerID='', UserID='', IPAddress='', IPMask='', MacAddress=''):
        ...
        self.UserID = 'TUserID' #用户代码, char[16]
        self.IPAddress = 'TIPAddress' #IP地址, char[16]
        self.IPMask = 'TIPAddress' #IP地址掩码, char[16]
        self.MacAddress = 'TMacAddress' #Mac地址, char[21]
...
class TradingNoticeInfo(BaseStruct): #用户事件通知信息
    def __init__(self, BrokerID='', InvestorID='', SendTime='', FieldContent='', SequenceSeries=0, SequenceNo=0):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.SendTime = 'TTime' #发送时间, char[9]
        self.FieldContent = 'TContent' #消息正文, char[501]
        self.SequenceSeries = 'TSequenceSeries' #序列系列号, short
        self.SequenceNo = 'TSequenceNo' #序列号, int
...
class ExchangeSequence(BaseStruct): #交易所状态
    def __init__(self, ExchangeID='', SequenceNo=0, MarketStatus=''):
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.SequenceNo = 'TSequenceNo' #序号, int
        self.MarketStatus = 'TInstrumentStatus' #合约交易状态, char
...
class BrokerTradingParams(BaseStruct): #经纪公司交易参数
    def __init__(self, BrokerID='', InvestorID='', MarginPriceType='', Algorithm='', AvailIncludeCloseProfit=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.MarginPriceType = 'TMarginPriceType' #保证金价格类型, char
        self.Algorithm = 'TAlgorithm' #盈亏算法, char
        self.AvailIncludeCloseProfit = 'TIncludeCloseProfit' #可用是否包含平仓盈利, char
...
class BrokerTradingAlgos(BaseStruct): #经纪公司交易算法
    def __init__(self, BrokerID='', ExchangeID='', InstrumentID='', HandlePositionAlgoID='', FindMarginRateAlgoID='', HandleTradingAccountAlgoID=''):
        ...
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.InstrumentID = 'TInstrumentID' #合约代码, char[31]
        self.HandlePositionAlgoID = 'THandlePositionAlgoID' #持仓处理算法编号, char
        self.FindMarginRateAlgoID = 'TFindMarginRateAlgoID' #寻找保证金率算法编号, char
        self.HandleTradingAccountAlgoID = 'THandleTradingAccountAlgoID' #资金处理算法编号, char
...
class BrokerDeposit(BaseStruct): #经纪公司资金
    def __init__(self, TradingDay='', BrokerID='', ParticipantID='', ExchangeID='', PreBalance=0.0, CurrMargin=0.0, CloseProfit=0.0, Balance=0.0, Deposit=0.0, Withdraw=0.0, Available=0.0, Reserve=0.0, FrozenMargin=0.0):
        self.TradingDay = 'TTradeDate' #交易日期, char[9]
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.ParticipantID = 'TParticipantID' #会员代码, char[11]
        self.ExchangeID = 'TExchangeID' #交易所代码, char[9]
        self.PreBalance = 'TMoney' #上次结算准备金, double
        ...
        self.Deposit = 'TMoney' #入金金额, double
        self.Withdraw = 'TMoney' #出金金额, double
        self.Available = 'TMoney' #可提资金, double
        self.Reserve = 'TMoney' #基本准备金, double
        self.FrozenMargin = 'TMoney' #冻结的保证金, double
...
class CFMMCBrokerKey(BaseStruct): #保证金监管系统经纪公司密钥
    def __init__(self, BrokerID='', ParticipantID='', CreateDate='', CreateTime='', KeyID=0, CurrentKey='', KeyKind=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.ParticipantID = 'TParticipantID' #经纪公司统一编码, char[11]
        self.CreateDate = 'TDate' #密钥生成日期, char[9]
        self.CreateTime = 'TTime' #密钥生成时间, char[9]
        self.KeyID = 'TSequenceNo' #密钥编号, int
        self.CurrentKey = 'TCFMMCKey' #动态密钥, char[21]
        self.KeyKind = 'TCFMMCKeyKind' #动态密钥类型, char
...
class BrokerUserOTPParam(BaseStruct): #用户动态令牌参数
    def __init__(self, BrokerID='', UserID='', OTPVendorsID='', SerialNumber='', AuthKey='', LastDrift=0, LastSuccess=0, OTPType=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.UserID = 'TUserID' #用户代码, char[16]
        self.OTPVendorsID = 'TOTPVendorsID' #动态令牌提供商, char[2]
        self.SerialNumber = 'TSerialNumber' #动态令牌序列号, char[17]
        self.AuthKey = 'TAuthKey' #令牌密钥, char[41]
        self.LastDrift = 'TLastDrift' #漂移值, int
        self.LastSuccess = 'TLastSuccess' #成功值, int
        self.OTPType = 'TOTPType' #动态令牌类型, char
...
class ManualSyncBrokerUserOTP(BaseStruct): #手工同步用户动态令牌
    def __init__(self, BrokerID='', UserID='', OTPType='', FirstOTP='', SecondOTP=''):
        ...
        self.UserID = 'TUserID' #用户代码, char[16]
        self.OTPType = 'TOTPType' #动态令牌类型, char
        self.FirstOTP = 'TPassword' #第一个动态密码, char[41]
        self.SecondOTP = 'TPassword' #第二个动态密码, char[41]

class CommRateModel(BaseStruct): #投资者手续费率模板
    def __init__(self, BrokerID='', CommModelID='', CommModelName=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.CommModelID = 'TInvestorID' #手续费率模板代码, char[13]
        self.CommModelName = 'TCommModelName' #模板名称, char[161]
...
class MarginModel(BaseStruct): #投资者保证金率模板
    def __init__(self, BrokerID='', MarginModelID='', MarginModelName=''):
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.MarginModelID = 'TInvestorID' #保证金率模板代码, char[13]
        self.MarginModelName = 'TCommModelName' #模板名称, char[161]
...
class ReqOpenAccount(BaseStruct): #转帐开户请求
    def __init__(self, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, CustomerName='', IdCardType='', IdentifiedCardNo='', Gender='', CountryCode='', CustType='', Address='', ZipCode='', Telephone='', MobilePhone='', Fax='', EMail='', MoneyAccountStatus='', BankAccount='', BankPassWord='', AccountID='', Password='', InstallID=0, VerifyCertNoFlag='', CurrencyID='', CashExchangeCode='', Digest='', BankAccType='', DeviceID='', BankSecuAccType='', BrokerIDByBank='', BankSecuAcc='', BankPwdFlag='', SecuPwdFlag='', OperNo='', TID=0, UserID=''):
        self.TradeCode = 'TTradeCode' #业务功能码, char[7]
        self.BankID = 'TBankID' #银行代码, char[4]
        self.BankBranchID = 'TBankBrchID' #银行分支机构代码, char[5]
        self.BrokerID = 'TBrokerID' #期商代码, char[11]
        self.BrokerBranchID = 'TFutureBranchID' #期商分支机构代码, char[31]
        self.TradeDate = 'TTradeDate' #交易日期, char[9]
        self.TradeTime = 'TTradeTime' #交易时间, char[9]
        self.BankSerial = 'TBankSerial' #银行流水号, char[13]
        self.TradingDay = 'TTradeDate' #交易系统日期 , char[9]
        self.PlateSerial = 'TSerial' #银期平台消息流水号, int
        self.LastFragment = 'TLastFragment' #最后分片标志, char
        self.SessionID = 'TSessionID' #会话号, int
        self.CustomerName = 'TIndividualName' #客户姓名, char[51]
        self.IdCardType = 'TIdCardType' #证件类型, char
        self.IdentifiedCardNo = 'TIdentifiedCardNo' #证件号码, char[51]
        self.Gender = 'TGender' #性别, char
        self.CountryCode = 'TCountryCode' #国家代码, char[21]
        self.CustType = 'TCustType' #客户类型, char
        self.Address = 'TAddress' #地址, char[101]
        self.ZipCode = 'TZipCode' #邮编, char[7]
        self.Telephone = 'TTelephone' #电话号码, char[41]
        self.MobilePhone = 'TMobilePhone' #手机, char[21]
        self.Fax = 'TFax' #传真, char[41]
        self.EMail = 'TEMail' #电子邮件, char[41]
        self.MoneyAccountStatus = 'TMoneyAccountStatus' #资金账户状态, char
        self.BankAccount = 'TBankAccount' #银行帐号, char[41]
        self.BankPassWord = 'TPassword' #银行密码, char[41]
        self.AccountID = 'TAccountID' #投资者帐号, char[13]
        self.Password = 'TPassword' #期货密码, char[41]
        self.InstallID = 'TInstallID' #安装编号, int
        self.VerifyCertNoFlag = 'TYesNoIndicator' #验证客户证件号码标志, char
        self.CurrencyID = 'TCurrencyID' #币种代码, char[4]
        self.CashExchangeCode = 'TCashExchangeCode' #汇钞标志, char
        self.Digest = 'TDigest' #摘要, char[36]
        self.BankAccType = 'TBankAccType' #银行帐号类型, char
        self.DeviceID = 'TDeviceID' #渠道标志, char[3]
        self.BankSecuAccType = 'TBankAccType' #期货单位帐号类型, char
        self.BrokerIDByBank = 'TBankCodingForFuture' #期货公司银行编码, char[33]
        self.BankSecuAcc = 'TBankAccount' #期货单位帐号, char[41]
        self.BankPwdFlag = 'TPwdFlag' #银行密码标志, char
        self.SecuPwdFlag = 'TPwdFlag' #期货资金密码核对标志, char
        self.OperNo = 'TOperNo' #交易柜员, char[17]
        self.TID = 'TTID' #交易ID, int
        self.UserID = 'TUserID' #用户标识, char[16]
...
class ReqChangeAccount(BaseStruct): #变更银行账户请求
    def __init__(self, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, CustomerName='', IdCardType='', IdentifiedCardNo='', Gender='', CountryCode='', CustType='', Address='', ZipCode='', Telephone='', MobilePhone='', Fax='', EMail='', MoneyAccountStatus='', BankAccount='', BankPassWord='', NewBankAccount='', NewBankPassWord='', AccountID='', Password='', BankAccType='', InstallID=0, VerifyCertNoFlag='', CurrencyID='', BrokerIDByBank='', BankPwdFlag='', SecuPwdFlag='', TID=0, Digest=''):
        ...
        self.BankAccount = 'TBankAccount' #银行帐号, char[41]
        self.BankPassWord = 'TPassword' #银行密码, char[41]
        self.NewBankAccount = 'TBankAccount' #新银行帐号, char[41]
        self.NewBankPassWord = 'TPassword' #新银行密码, char[41]
        self.AccountID = 'TAccountID' #投资者帐号, char[13]
        self.Password = 'TPassword' #期货密码, char[41]
        self.BankAccType = 'TBankAccType' #银行帐号类型, char
        self.InstallID = 'TInstallID' #安装编号, int
...
class ReqTransfer(BaseStruct): #转账请求
    def __init__(self, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, CustomerName='', IdCardType='', IdentifiedCardNo='', CustType='', BankAccount='', BankPassWord='', AccountID='', Password='', InstallID=0, FutureSerial=0, UserID='', VerifyCertNoFlag='', CurrencyID='', TradeAmount=0.0, FutureFetchAmount=0.0, FeePayFlag='', CustFee=0.0, BrokerFee=0.0, Message='', Digest='', BankAccType='', DeviceID='', BankSecuAccType='', BrokerIDByBank='', BankSecuAcc='', BankPwdFlag='', SecuPwdFlag='', OperNo='', RequestID=0, TID=0, TransferStatus=''):
        ...
        self.Password = 'TPassword' #期货密码, char[41]
        self.InstallID = 'TInstallID' #安装编号, int
        self.FutureSerial = 'TFutureSerial' #期货公司流水号, int
        self.UserID = 'TUserID' #用户标识, char[16]
        self.VerifyCertNoFlag = 'TYesNoIndicator' #验证客户证件号码标志, char
        self.CurrencyID = 'TCurrencyID' #币种代码, char[4]
        self.TradeAmount = 'TTradeAmount' #转帐金额, double
        self.FutureFetchAmount = 'TTradeAmount' #期货可取金额, double
        self.FeePayFlag = 'TFeePayFlag' #费用支付标志, char
        self.CustFee = 'TCustFee' #应收客户费用, double
        self.BrokerFee = 'TFutureFee' #应收期货公司费用, double
        self.Message = 'TAddInfo' #发送方给接收方的消息, char[129]
        self.Digest = 'TDigest' #摘要, char[36]
        self.BankAccType = 'TBankAccType' #银行帐号类型, char
        self.DeviceID = 'TDeviceID' #渠道标志, char[3]
        self.BankSecuAccType = 'TBankAccType' #期货单位帐号类型, char
        ...
        self.RequestID = 'TRequestID' #请求编号, int
        self.TID = 'TTID' #交易ID, int
        self.TransferStatus = 'TTransferStatus' #转账交易状态, char
...
class ReqRepeal(BaseStruct): #冲正请求
    def __init__(self, RepealTimeInterval=0, RepealedTimes=0, BankRepealFlag='', BrokerRepealFlag='', PlateRepealSerial=0, BankRepealSerial='', FutureRepealSerial=0, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, CustomerName='', IdCardType='', IdentifiedCardNo='', CustType='', BankAccount='', BankPassWord='', AccountID='', Password='', InstallID=0, FutureSerial=0, UserID='', VerifyCertNoFlag='', CurrencyID='', TradeAmount=0.0, FutureFetchAmount=0.0, FeePayFlag='', CustFee=0.0, BrokerFee=0.0, Message='', Digest='', BankAccType='', DeviceID='', BankSecuAccType='', BrokerIDByBank='', BankSecuAcc='', BankPwdFlag='', SecuPwdFlag='', OperNo='', RequestID=0, TID=0, TransferStatus=''):
        self.RepealTimeInterval = 'TRepealTimeInterval' #冲正时间间隔, int
        self.RepealedTimes = 'TRepealedTimes' #已经冲正次数, int
        self.BankRepealFlag = 'TBankRepealFlag' #银行冲正标志, char
        self.BrokerRepealFlag = 'TBrokerRepealFlag' #期商冲正标志, char
        self.PlateRepealSerial = 'TPlateSerial' #被冲正平台流水号, int
        self.BankRepealSerial = 'TBankSerial' #被冲正银行流水号, char[13]
        self.FutureRepealSerial = 'TFutureSerial' #被冲正期货流水号, int
        self.TradeCode = 'TTradeCode' #业务功能码, char[7]
        self.BankID = 'TBankID' #银行代码, char[4]
        self.BankBranchID = 'TBankBrchID' #银行分支机构代码, char[5]
        self.BrokerID = 'TBrokerID' #期商代码, char[11]
...
class RspQueryAccount(BaseStruct): #查询账户信息响应
    def __init__(self, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, CustomerName='', IdCardType='', IdentifiedCardNo='', CustType='', BankAccount='', BankPassWord='', AccountID='', Password='', FutureSerial=0, InstallID=0, UserID='', VerifyCertNoFlag='', CurrencyID='', Digest='', BankAccType='', DeviceID='', BankSecuAccType='', BrokerIDByBank='', BankSecuAcc='', BankPwdFlag='', SecuPwdFlag='', OperNo='', RequestID=0, TID=0, BankUseAmount=0.0, BankFetchAmount=0.0):
        ...
        self.RequestID = 'TRequestID' #请求编号, int
        self.TID = 'TTID' #交易ID, int
        self.BankUseAmount = 'TTradeAmount' #银行可用金额, double
        self.BankFetchAmount = 'TTradeAmount' #银行可取金额, double
...
class RspFutureSignIn(BaseStruct): #期商签到响应
    def __init__(self, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, InstallID=0, UserID='', Digest='', CurrencyID='', DeviceID='', BrokerIDByBank='', OperNo='', RequestID=0, TID=0, ErrorID=0, ErrorMsg='', PinKey='', MacKey=''):
        ...
        self.ErrorID = 'TErrorID' #错误代码, int
        self.ErrorMsg = 'TErrorMsg' #错误信息, char[81]
        self.PinKey = 'TPasswordKey' #PIN密钥, char[129]
        self.MacKey = 'TPasswordKey' #MAC密钥, char[129]
...
class ReqQueryTradeResultBySerial(BaseStruct): #查询指定流水号的交易结果请求
    def __init__(self, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, Reference=0, RefrenceIssureType='', RefrenceIssure='', CustomerName='', IdCardType='', IdentifiedCardNo='', CustType='', BankAccount='', BankPassWord='', AccountID='', Password='', CurrencyID='', TradeAmount=0.0, Digest=''):
        ...
        self.LastFragment = 'TLastFragment' #最后分片标志, char
        self.SessionID = 'TSessionID' #会话号, int
        self.Reference = 'TSerial' #流水号, int
        self.RefrenceIssureType = 'TInstitutionType' #本流水号发布者的机构类型, char
        self.RefrenceIssure = 'TOrganCode' #本流水号发布者机构编码, char[36]
        self.CustomerName = 'TIndividualName' #客户姓名, char[51]
        self.IdCardType = 'TIdCardType' #证件类型, char
        self.IdentifiedCardNo = 'TIdentifiedCardNo' #证件号码, char[51]
        self.CustType = 'TCustType' #客户类型, char
...
class RspQueryTradeResultBySerial(BaseStruct): #查询指定流水号的交易结果响应
    def __init__(self, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, ErrorID=0, ErrorMsg='', Reference=0, RefrenceIssureType='', RefrenceIssure='', OriginReturnCode='', OriginDescrInfoForReturnCode='', BankAccount='', BankPassWord='', AccountID='', Password='', CurrencyID='', TradeAmount=0.0, Digest=''):
        ...
        self.RefrenceIssureType = 'TInstitutionType' #本流水号发布者的机构类型, char
        self.RefrenceIssure = 'TOrganCode' #本流水号发布者机构编码, char[36]
        self.OriginReturnCode = 'TReturnCode' #原始返回代码, char[7]
        self.OriginDescrInfoForReturnCode = 'TDescrInfoForReturnCode' #原始返回码描述, char[129]
        self.BankAccount = 'TBankAccount' #银行帐号, char[41]
        self.BankPassWord = 'TPassword' #银行密码, char[41]
        self.AccountID = 'TAccountID' #投资者帐号, char[13]
        self.Password = 'TPassword' #期货密码, char[41]
...
class ReqDayEndFileReady(BaseStruct): #日终文件就绪请求
    def __init__(self, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, FileBusinessCode='', Digest=''):
        ...
        self.LastFragment = 'TLastFragment' #最后分片标志, char
        self.SessionID = 'TSessionID' #会话号, int
        self.FileBusinessCode = 'TFileBusinessCode' #文件业务功能, char
        self.Digest = 'TDigest' #摘要, char[36]

class ReturnResult(BaseStruct): #返回结果
    def __init__(self, ReturnCode='', DescrInfoForReturnCode=''):
        self.ReturnCode = 'TReturnCode' #返回代码, char[7]
        self.DescrInfoForReturnCode = 'TDescrInfoForReturnCode' #返回码描述, char[129]
...
class DepositResultInform(BaseStruct): #验证期货资金密码和客户信息
    def __init__(self, DepositSeqNo='', BrokerID='', InvestorID='', Deposit=0.0, RequestID=0, ReturnCode='', DescrInfoForReturnCode=''):
        self.DepositSeqNo = 'TDepositSeqNo' #出入金流水号，该流水号为银期报盘返回的流水号, char[15]
        self.BrokerID = 'TBrokerID' #经纪公司代码, char[11]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.Deposit = 'TMoney' #入金金额, double
        self.RequestID = 'TRequestID' #请求编号, int
...
class ReqSyncKey(BaseStruct): #交易核心向银期报盘发出密钥同步请求
    def __init__(self, TradeCode='', BankID='', BankBranchID='', BrokerID='', BrokerBranchID='', TradeDate='', TradeTime='', BankSerial='', TradingDay='', PlateSerial=0, LastFragment='', SessionID=0, InstallID=0, UserID='', Message='', DeviceID='', BrokerIDByBank='', OperNo='', RequestID=0, TID=0):
        ...
        self.InstallID = 'TInstallID' #安装编号, int
        self.UserID = 'TUserID' #用户标识, char[16]
        self.Message = 'TAddInfo' #交易核心给银期报盘的消息, char[129]
        self.DeviceID = 'TDeviceID' #渠道标志, char[3]
        self.BrokerIDByBank = 'TBankCodingForFuture' #期货公司银行编码, char[33]
        self.OperNo = 'TOperNo' #交易柜员, char[17]
        self.RequestID = 'TRequestID' #请求编号, int
...
class TransferSerial(BaseStruct): #银期转账交易流水表
    def __init__(self, PlateSerial=0, TradeDate='', TradingDay='', TradeTime='', TradeCode='', SessionID=0, BankID='', BankBranchID='', BankAccType='', BankAccount='', BankSerial='', BrokerID='', BrokerBranchID='', FutureAccType='', AccountID='', InvestorID='', FutureSerial=0, IdCardType='', IdentifiedCardNo='', CurrencyID='', TradeAmount=0.0, CustFee=0.0, BrokerFee=0.0, AvailabilityFlag='', OperatorCode='', BankNewAccount='', ErrorID=0, ErrorMsg=''):
        self.PlateSerial = 'TPlateSerial' #平台流水号, int
        self.TradeDate = 'TTradeDate' #交易发起方日期, char[9]
        self.TradingDay = 'TDate' #交易日期, char[9]
        self.TradeTime = 'TTradeTime' #交易时间, char[9]
        self.TradeCode = 'TTradeCode' #交易代码, char[7]
        self.SessionID = 'TSessionID' #会话编号, int
        self.BankID = 'TBankID' #银行编码, char[4]
        self.BankBranchID = 'TBankBrchID' #银行分支机构编码, char[5]
        self.BankAccType = 'TBankAccType' #银行帐号类型, char
        self.BankAccount = 'TBankAccount' #银行帐号, char[41]
        self.BankSerial = 'TBankSerial' #银行流水号, char[13]
        self.BrokerID = 'TBrokerID' #期货公司编码, char[11]
        self.BrokerBranchID = 'TFutureBranchID' #期商分支机构代码, char[31]
        self.FutureAccType = 'TFutureAccType' #期货公司帐号类型, char
        self.AccountID = 'TAccountID' #投资者帐号, char[13]
        self.InvestorID = 'TInvestorID' #投资者代码, char[13]
        self.FutureSerial = 'TFutureSerial' #期货公司流水号, int
        self.IdCardType = 'TIdCardType' #证件类型, char
        self.IdentifiedCardNo = 'TIdentifiedCardNo' #证件号码, char[51]
        self.CurrencyID = 'TCurrencyID' #币种代码, char[4]
        self.TradeAmount = 'TTradeAmount' #交易金额, double
        self.CustFee = 'TCustFee' #应收客户费用, double
        self.BrokerFee = 'TFutureFee' #应收期货公司费用, double
        self.AvailabilityFlag = 'TAvailabilityFlag' #有效标志, char
        self.OperatorCode = 'TOperatorCode' #操作员, char[17]
        self.BankNewAccount = 'TBankAccount' #新银行帐号, char[41]
        self.ErrorID = 'TErrorID' #错误代码, int
        self.ErrorMsg = 'TErrorMsg' #错误信息, char[81]
...
class Accountregister(BaseStruct): #客户开销户信息表
    def __init__(self, TradeDay='', BankID='', BankBranchID='', BankAccount='', BrokerID='', BrokerBranchID='', AccountID='', IdCardType='', IdentifiedCardNo='', CustomerName='', CurrencyID='', OpenOrDestroy='', RegDate='', OutDate='', TID=0, CustType='', BankAccType=''):
        self.TradeDay = 'TTradeDate' #交易日期, char[9]
        self.BankID = 'TBankID' #银行编码, char[4]
        self.BankBranchID = 'TBankBrchID' #银行分支机构编码, char[5]
        self.BankAccount = 'TBankAccount' #银行帐号, char[41]
        self.BrokerID = 'TBrokerID' #期货公司编码, char[11]
        self.BrokerBranchID = 'TFutureBranchID' #期货公司分支机构编码, char[31]
        self.AccountID = 'TAccountID' #投资者帐号, char[13]
        self.IdCardType = 'TIdCardType' #证件类型, char
        self.IdentifiedCardNo = 'TIdentifiedCardNo' #证件号码, char[51]
        self.CustomerName = 'TIndividualName' #客户姓名, char[51]
        self.CurrencyID = 'TCurrencyID' #币种代码, char[4]
        self.OpenOrDestroy = 'TOpenOrDestroy' #开销户类别, char
        self.RegDate = 'TTradeDate' #签约日期, char[9]
        self.OutDate = 'TTradeDate' #解约日期, char[9]
        self.TID = 'TTID' #交易ID, int
        self.CustType = 'TCustType' #客户类型, char
        self.BankAccType = 'TBankAccType' #银行帐号类型, char
...
class MulticastGroupInfo(BaseStruct): #UDP组播组信息
    def __init__(self, GroupIP='', GroupPort=0, SourceIP=''):
        self.GroupIP = 'TIPAddress' #组播组IP地址, char[16]
        self.GroupPort = 'TIPPort' #组播组IP端口, int
        self.SourceIP = 'TIPAddress' #源地址, char[16]
...
def _init():
    ...
    T['TTraderID'] = c_char * 21 #交易所交易员代码
    T['TInvestorID'] = c_char * 13 #投资者代码
    T['TBrokerID'] = c_char * 11 #经纪公司代码
    T['TBrokerAbbr'] = c_char * 9 #经纪公司简称
    T['TBrokerName'] = c_char * 81 #经纪公司名称
    T['TExchangeInstID'] = c_char * 31 #合约在交易所的代码
    T['TOrderRef'] = c_char * 13 #报单引用
    T['TParticipantID'] = c_char * 11 #会员代码
    T['TUserID'] = c_char * 16 #用户代码
    T['TPassword'] = c_char * 41 #密码
    T['TClientID'] = c_char * 11 #交易编码
    T['TInstrumentID'] = c_char * 31 #合约代码
    T['TMarketID'] = c_char * 31 #市场代码
    ...
    T['TSystemID'] = c_char * 21 #系统编号
    T['TExchangeProperty'] = c_char #交易所属性
    T['TDate'] = c_char * 9 #日期
    T['TTime'] = c_char * 9 #时间
    T['TLongTime'] = c_char * 13 #长时间
    T['TInstrumentName'] = c_char * 21 #合约名称
    T['TSettlementGroupID'] = c_char * 9 #结算组代码
    T['TOrderSysID'] = c_char * 21 #报单编号
    T['TTradeID'] = c_char * 21 #成交编号
    T['TCommandType'] = c_char * 65 #DB命令类型
    T['TIPAddress'] = c_char * 16 #IP地址
    T['TIPPort'] = c_int #IP端口
    T['TProductInfo'] = c_char * 11 #产品信息
    T['TProtocolInfo'] = c_char * 11 #协议信息
    T['TBusinessUnit'] = c_char * 21 #业务单元
    T['TDepositSeqNo'] = c_char * 15 #出入金流水号
    T['TIdentifiedCardNo'] = c_char * 51 #证件号码
    T['TIdCardType'] = c_char #证件类型
    T['TOrderLocalID'] = c_char * 13 #本地报单编号
    T['TUserName'] = c_char * 81 #用户名称
    T['TPartyName'] = c_char * 81 #参与人名称
    T['TErrorMsg'] = c_char * 81 #错误信息
    T['TFieldName'] = c_char * 2049 #字段名
    T['TFieldContent'] = c_char * 2049 #字段内容
    T['TSystemName'] = c_char * 41 #系统名称
    T['TContent'] = c_char * 501 #消息正文
    T['TInvestorRange'] = c_char #投资者范围
    T['TDepartmentRange'] = c_char #投资者范围
    T['TDataSyncStatus'] = c_char #数据同步状态
    T['TBrokerDataSyncStatus'] = c_char #经纪公司数据同步状态
    T['TExchangeConnectStatus'] = c_char #交易所连接状态
    T['TTraderConnectStatus'] = c_char #交易所交易员连接状态
    T['TFunctionCode'] = c_char #功能代码
    T['TBrokerFunctionCode'] = c_char #经纪公司功能代码
    T['TOrderActionStatus'] = c_char #报单操作状态
    T['TOrderStatus'] = c_char #报单状态
    T['TOrderSubmitStatus'] = c_char #报单提交状态
    T['TPositionDate'] = c_char #持仓日期
    T['TPositionDateType'] = c_char #持仓日期类型
    T['TTradingRole'] = c_char #交易角色
    T['TProductClass'] = c_char #产品类型
    T['TInstLifePhase'] = c_char #合约生命周期状态
    T['TDirection'] = c_char #买卖方向
    T['TPositionType'] = c_char #持仓类型
    T['TPosiDirection'] = c_char #持仓多空方向
    T['TSysSettlementStatus'] = c_char #系统结算状态
    T['TRatioAttr'] = c_char #费率属性
    T['THedgeFlag'] = c_char #投机套保标志
    T['TBillHedgeFlag'] = c_char #投机套保标志
    T['TClientIDType'] = c_char #交易编码类型
    T['TOrderPriceType'] = c_char #报单价格条件
    T['TOffsetFlag'] = c_char #开平标志
    T['TForceCloseReason'] = c_char #强平原因
    T['TOrderType'] = c_char #报单类型
    T['TTimeCondition'] = c_char #有效期类型
    T['TVolumeCondition'] = c_char #成交量类型
    T['TContingentCondition'] = c_char #触发条件
    T['TActionFlag'] = c_char #操作标志
    T['TTradingRight'] = c_char #交易权限
    T['TOrderSource'] = c_char #报单来源
    T['TTradeType'] = c_char #成交类型
    T['TPriceSource'] = c_char #成交价来源
    T['TInstrumentStatus'] = c_char #合约交易状态
    T['TInstStatusEnterReason'] = c_char #品种进入交易状态原因
    T['TOrderActionRef'] = c_int #报单操作引用
    T['TInstallCount'] = c_int #安装数量
    T['TInstallID'] = c_int #安装编号
    T['TErrorID'] = c_int #错误代码
    T['TSettlementID'] = c_int #结算编号
    T['TVolume'] = c_int #数量
    T['TFrontID'] = c_int #前置编号
    T['TSessionID'] = c_int #会话编号
    T['TSequenceNo'] = c_int #序号
    T['TCommandNo'] = c_int #DB命令序号
    T['TMillisec'] = c_int #时间（毫秒）
    T['TVolumeMultiple'] = c_int #合约数量乘数
    ...
    T['TCombOffsetFlag'] = c_char * 5 #组合开平标志
    T['TCombHedgeFlag'] = c_char * 5 #组合投机套保标志
    ...
    T['TPriority'] = c_int #优先级
    T['TContractCode'] = c_char * 41 #合同编号
    T['TCity'] = c_char * 41 #市
    T['TIsStock'] = c_char * 11 #是否股民
    ...
    T['TCompanyCode'] = c_char * 51 #企业代码
    T['TWebsite'] = c_char * 51 #网站地址
    T['TTaxNo'] = c_char * 31 #税务登记号
    T['TBatchStatus'] = c_char #处理状态
    T['TPropertyID'] = c_char * 33 #属性代码
    T['TPropertyName'] = c_char * 65 #属性名称
    T['TLicenseNo'] = c_char * 51 #营业执照号
    T['TAgentID'] = c_char * 13 #经纪人代码
    T['TAgentName'] = c_char * 41 #经纪人名称
    T['TAgentGroupID'] = c_char * 13 #经纪人组代码
    T['TAgentGroupName'] = c_char * 41 #经纪人组名称
    T['TReturnStyle'] = c_char #按品种返还方式
    T['TReturnPattern'] = c_char #返还模式
    T['TReturnLevel'] = c_char #返还级别
    T['TReturnStandard'] = c_char #返还标准
    T['TMortgageType'] = c_char #质押类型
    T['TInvestorSettlementParamID'] = c_char #投资者结算参数代码
    T['TExchangeSettlementParamID'] = c_char #交易所结算参数代码
    T['TSystemParamID'] = c_char #系统参数代码
    T['TTradeParamID'] = c_char #交易系统参数代码
    T['TSettlementParamValue'] = c_char * 256 #参数代码值
    T['TCounterID'] = c_char * 33 #计数器代码
    T['TInvestorGroupName'] = c_char * 41 #投资者分组名称
    T['TBrandCode'] = c_char * 257 #牌号
    T['TWarehouse'] = c_char * 257 #仓库
    T['TProductDate'] = c_char * 41 #产期
    T['TGrade'] = c_char * 41 #等级
    T['TClassify'] = c_char * 41 #类别
    T['TPosition'] = c_char * 41 #货位
    T['TYieldly'] = c_char * 41 #产地
    T['TWeight'] = c_char * 41 #公定重量
    T['TSubEntryFundNo'] = c_int #分项资金流水号
    T['TFileID'] = c_char #文件标识
    T['TFileName'] = c_char * 257 #文件名称
    T['TFileType'] = c_char #文件上传类型
    T['TFileFormat'] = c_char #文件格式
    T['TFileUploadStatus'] = c_char #文件状态
    T['TTransferDirection'] = c_char #移仓方向
    T['TUploadMode'] = c_char * 21 #上传文件类型
    T['TAccountID'] = c_char * 13 #投资者帐号
    T['TBankFlag'] = c_char #银行统一标识类型
    T['TBankAccount'] = c_char * 41 #银行账户
    T['TOpenName'] = c_char * 61 #银行账户的开户人名称
    T['TOpenBank'] = c_char * 101 #银行账户的开户行
    T['TBankName'] = c_char * 101 #银行名称
    T['TPublishPath'] = c_char * 257 #发布路径
    T['TOperatorID'] = c_char * 65 #操作员代码
    T['TMonthCount'] = c_int #月份数量
    T['TAdvanceMonthArray'] = c_char * 13 #月份提前数组
    T['TDateExpr'] = c_char * 1025 #日期表达式
    T['TInstrumentIDExpr'] = c_char * 41 #合约代码表达式
    T['TInstrumentNameExpr'] = c_char * 41 #合约名称表达式
    T['TSpecialCreateRule'] = c_char #特殊的创建规则
    T['TBasisPriceType'] = c_char #挂牌基准价类型
    T['TProductLifePhase'] = c_char #产品生命周期状态
    T['TDeliveryMode'] = c_char #交割方式
    T['TLogLevel'] = c_char * 33 #日志级别
    T['TProcessName'] = c_char * 257 #存储过程名称
    T['TOperationMemo'] = c_char * 1025 #操作摘要
    T['TFundIOType'] = c_char #出入金类型
    T['TFundType'] = c_char #资金类型
    T['TFundDirection'] = c_char #出入金方向
    T['TFundStatus'] = c_char #资金状态
    T['TBillNo'] = c_char * 15 #票据号
    T['TBillName'] = c_char * 33 #票据名称
    T['TPublishStatus'] = c_char #发布状态
    T['TEnumValueID'] = c_char * 65 #枚举值代码
    T['TEnumValueType'] = c_char * 33 #枚举值类型
    T['TEnumValueLabel'] = c_char * 65 #枚举值名称
    T['TEnumValueResult'] = c_char * 33 #枚举值结果
    T['TSystemStatus'] = c_char #系统状态
    T['TSettlementStatus'] = c_char #结算状态
    T['TRangeIntType'] = c_char * 33 #限定值类型
    T['TRangeIntFrom'] = c_char * 33 #限定值下限
    T['TRangeIntTo'] = c_char * 33 #限定值上限
    T['TFunctionID'] = c_char * 25 #功能代码
    T['TFunctionValueCode'] = c_char * 257 #功能编码
    T['TFunctionName'] = c_char * 65 #功能名称
    T['TRoleID'] = c_char * 11 #角色编号
    T['TRoleName'] = c_char * 41 #角色名称
    T['TDescription'] = c_char * 401 #描述
    T['TCombineID'] = c_char * 25 #组合编号
    T['TCombineType'] = c_char * 25 #组合类型
    T['TInvestorType'] = c_char #投资者类型
    T['TBrokerType'] = c_char #经纪公司类型
    T['TRiskLevel'] = c_char #风险等级
    T['TFeeAcceptStyle'] = c_char #手续费收取方式
    T['TPasswordType'] = c_char #密码类型
    T['TAlgorithm'] = c_char #盈亏算法
    T['TIncludeCloseProfit'] = c_char #是否包含平仓盈利
    T['TAllWithoutTrade'] = c_char #是否受可提比例限制
    T['TComment'] = c_char * 31 #盈亏算法说明
    T['TVersion'] = c_char * 4 #版本号
    T['TTradeCode'] = c_char * 7 #交易代码
    T['TTradeDate'] = c_char * 9 #交易日期
    T['TTradeTime'] = c_char * 9 #交易时间
    T['TTradeSerial'] = c_char * 9 #发起方流水号
    T['TTradeSerialNo'] = c_int #发起方流水号
    T['TFutureID'] = c_char * 11 #期货公司代码
    T['TBankID'] = c_char * 4 #银行代码
    T['TBankBrchID'] = c_char * 5 #银行分中心代码
    T['TBankBranchID'] = c_char * 11 #分中心代码
    T['TOperNo'] = c_char * 17 #交易柜员
    T['TDeviceID'] = c_char * 3 #渠道标志
    T['TRecordNum'] = c_char * 7 #记录数
    T['TFutureAccount'] = c_char * 22 #期货资金账号
    T['TFuturePwdFlag'] = c_char #资金密码核对标志
    T['TTransferType'] = c_char #银期转账类型
    T['TFutureAccPwd'] = c_char * 17 #期货资金密码
    T['TCurrencyCode'] = c_char * 4 #币种
    T['TRetCode'] = c_char * 5 #响应代码
    T['TRetInfo'] = c_char * 129 #响应信息
    T['TTradeAmt'] = c_char * 20 #银行总余额
    T['TUseAmt'] = c_char * 20 #银行可用余额
    T['TFetchAmt'] = c_char * 20 #银行可取余额
    T['TTransferValidFlag'] = c_char #转账有效标志
    T['TCertCode'] = c_char * 21 #证件号码
    T['TReason'] = c_char #事由
    T['TFundProjectID'] = c_char * 5 #资金项目编号
    T['TSex'] = c_char #性别
    T['TProfession'] = c_char * 41 #职业
    T['TNational'] = c_char * 31 #国籍
    T['TProvince'] = c_char * 16 #省
    T['TRegion'] = c_char * 16 #区
    T['TCountry'] = c_char * 16 #国家
    T['TLicenseNO'] = c_char * 33 #营业执照
    T['TCompanyType'] = c_char * 16 #企业性质
    T['TBusinessScope'] = c_char * 1001 #经营范围
    T['TCapitalCurrency'] = c_char * 4 #注册资本币种
    T['TUserType'] = c_char #用户类型
    T['TRateType'] = c_char #费率类型
    T['TNoteType'] = c_char #通知类型
    T['TSettlementStyle'] = c_char #结算单方式
    T['TBrokerDNS'] = c_char * 256 #域名
    T['TSentence'] = c_char * 501 #语句
    T['TSettlementBillType'] = c_char #结算单类型
    T['TUserRightType'] = c_char #客户权限类型
    T['TMarginPriceType'] = c_char #保证金价格类型
    T['TBillGenStatus'] = c_char #结算单生成状态
    T['TAlgoType'] = c_char #算法类型
    T['THandlePositionAlgoID'] = c_char #持仓处理算法编号
    T['TFindMarginRateAlgoID'] = c_char #寻找保证金率算法编号
    T['THandleTradingAccountAlgoID'] = c_char #资金处理算法编号
    T['TPersonType'] = c_char #联系人类型
    T['TQueryInvestorRange'] = c_char #查询范围
    T['TInvestorRiskStatus'] = c_char #投资者风险状态
    T['TLegID'] = c_int #单腿编号
    T['TLegMultiple'] = c_int #单腿乘数
    T['TImplyLevel'] = c_int #派生层数
    T['TClearAccount'] = c_char * 33 #结算账户
    T['TOrganNO'] = c_char * 6 #结算账户
    T['TClearbarchID'] = c_char * 6 #结算账户联行号
    T['TUserEventType'] = c_char #用户事件类型
    T['TUserEventInfo'] = c_char * 1025 #用户事件信息
    T['TCloseStyle'] = c_char #平仓方式
    T['TStatMode'] = c_char #统计方式
    T['TParkedOrderStatus'] = c_char #预埋单状态
    T['TParkedOrderID'] = c_char * 13 #预埋报单编号
    T['TParkedOrderActionID'] = c_char * 13 #预埋撤单编号
    T['TVirDealStatus'] = c_char #处理状态
    T['TOrgSystemID'] = c_char #原有系统代码
    T['TVirTradeStatus'] = c_char #交易状态
    T['TVirBankAccType'] = c_char #银行帐户类型
    T['TVirementStatus'] = c_char #银行帐户类型
    T['TVirementAvailAbility'] = c_char #有效标志
    T['TVirementTradeCode'] = c_char #交易代码
    T['TPhotoTypeName'] = c_char * 41 #影像类型名称
    T['TPhotoTypeID'] = c_char * 5 #影像类型代码
    T['TPhotoName'] = c_char * 161 #影像名称
    T['TTopicID'] = c_int #主题代码
    T['TReportTypeID'] = c_char * 3 #交易报告类型标识
    T['TCharacterID'] = c_char * 5 #交易特征代码
    T['TAMLParamID'] = c_char * 21 #参数代码
    T['TAMLInvestorType'] = c_char * 3 #投资者类型
    T['TAMLIdCardType'] = c_char * 3 #证件类型
    T['TAMLTradeDirect'] = c_char * 3 #资金进出方向
    T['TAMLTradeModel'] = c_char * 3 #资金进出方式
    T['TAMLParamID'] = c_char * 21 #参数代码
    T['TAMLOpParamValue'] = c_double #业务参数代码值
    T['TAMLCustomerCardType'] = c_char * 81 #客户身份证件/证明文件类型
    T['TAMLInstitutionName'] = c_char * 65 #金融机构网点名称
    T['TAMLDistrictID'] = c_char * 7 #金融机构网点所在地区行政区划代码
    T['TAMLRelationShip'] = c_char * 3 #金融机构网点与大额交易的关系
    T['TAMLInstitutionType'] = c_char * 3 #金融机构网点代码类型
    T['TAMLInstitutionID'] = c_char * 13 #金融机构网点代码
    T['TAMLAccountType'] = c_char * 5 #账户类型
    T['TAMLTradingType'] = c_char * 7 #交易方式
    T['TAMLTransactClass'] = c_char * 7 #涉外收支交易分类与代码
    T['TAMLCapitalIO'] = c_char * 3 #资金收付标识
    T['TAMLSite'] = c_char * 10 #交易地点
    T['TAMLCapitalPurpose'] = c_char * 129 #资金用途
    T['TAMLReportType'] = c_char * 2 #报文类型
    T['TAMLSerialNo'] = c_char * 5 #编号
    T['TAMLStatus'] = c_char * 2 #状态
    T['TAMLGenStatus'] = c_char #Aml生成方式
    T['TAMLSeqCode'] = c_char * 65 #业务标识号
    T['TAMLFileName'] = c_char * 257 #AML文件名
    T['TAMLMoney'] = c_double #反洗钱资金
    T['TAMLFileAmount'] = c_int #反洗钱资金
    T['TCFMMCKey'] = c_char * 21 #密钥类型(保证金监管)
    T['TCFMMCKeyKind'] = c_char #动态密钥类别(保证金监管)
    T['TAMLReportName'] = c_char * 81 #报文名称
    T['TIndividualName'] = c_char * 51 #个人姓名
    T['TCurrencyID'] = c_char * 4 #币种代码
    T['TCustNumber'] = c_char * 36 #客户编号
    T['TOrganCode'] = c_char * 36 #机构编码
    T['TOrganName'] = c_char * 71 #机构名称
    T['TSuperOrganCode'] = c_char * 12 #上级机构编码,即期货公司总部、银行总行
    T['TSubBranchID'] = c_char * 31 #分支机构
    T['TSubBranchName'] = c_char * 71 #分支机构名称
    T['TBranchNetCode'] = c_char * 31 #机构网点号
    T['TBranchNetName'] = c_char * 71 #机构网点名称
    T['TOrganFlag'] = c_char * 2 #机构标识
    T['TBankCodingForFuture'] = c_char * 33 #银行对期货公司的编码
    T['TBankReturnCode'] = c_char * 7 #银行对返回码的定义
    T['TPlateReturnCode'] = c_char * 5 #银期转帐平台对返回码的定义
    T['TBankSubBranchID'] = c_char * 31 #银行分支机构编码
    T['TFutureBranchID'] = c_char * 31 #期货分支机构编码
    T['TReturnCode'] = c_char * 7 #返回代码
    T['TOperatorCode'] = c_char * 17 #操作员
    T['TClearDepID'] = c_char * 6 #机构结算帐户机构号
    T['TClearBrchID'] = c_char * 6 #机构结算帐户联行号
    T['TClearName'] = c_char * 71 #机构结算帐户名称
    T['TBankAccountName'] = c_char * 71 #银行帐户名称
    T['TInvDepID'] = c_char * 6 #机构投资人账号机构号
    T['TInvBrchID'] = c_char * 6 #机构投资人联行号
    T['TMessageFormatVersion'] = c_char * 36 #信息格式版本
    T['TDigest'] = c_char * 36 #摘要
    T['TAuthenticData'] = c_char * 129 #认证数据
    T['TPasswordKey'] = c_char * 129 #密钥
    T['TFutureAccountName'] = c_char * 129 #期货帐户名称
    T['TMobilePhone'] = c_char * 21 #手机
    T['TFutureMainKey'] = c_char * 129 #期货公司主密钥
    T['TFutureWorkKey'] = c_char * 129 #期货公司工作密钥
    T['TFutureTransKey'] = c_char * 129 #期货公司传输密钥
    T['TBankMainKey'] = c_char * 129 #银行主密钥
    T['TBankWorkKey'] = c_char * 129 #银行工作密钥
    T['TBankTransKey'] = c_char * 129 #银行传输密钥
    T['TBankServerDescription'] = c_char * 129 #银行服务器描述信息
    T['TAddInfo'] = c_char * 129 #附加信息
    T['TDescrInfoForReturnCode'] = c_char * 129 #返回码描述
    T['TCountryCode'] = c_char * 21 #国家代码
    T['TSerial'] = c_int #流水号
    T['TPlateSerial'] = c_int #平台流水号
    T['TBankSerial'] = c_char * 13 #银行流水号
    T['TCorrectSerial'] = c_int #被冲正交易流水号
    T['TFutureSerial'] = c_int #期货公司流水号
    T['TApplicationID'] = c_int #应用标识
    T['TBankProxyID'] = c_int #银行代理标识
    T['TFBTCoreID'] = c_int #银期转帐核心系统标识
    T['TServerPort'] = c_int #服务端口号
    T['TRepealedTimes'] = c_int #已经冲正次数
    T['TRepealTimeInterval'] = c_int #冲正时间间隔
    T['TTotalTimes'] = c_int #每日累计转帐次数
    T['TFBTRequestID'] = c_int #请求ID
    T['TTID'] = c_int #交易ID
    T['TTradeAmount'] = c_double #交易金额（元）
    T['TCustFee'] = c_double #应收客户费用（元）
    T['TFutureFee'] = c_double #应收期货公司费用（元）
    T['TSingleMaxAmt'] = c_double #单笔最高限额
    T['TSingleMinAmt'] = c_double #单笔最低限额
    T['TTotalAmt'] = c_double #每日累计转帐额度
    T['TCertificationType'] = c_char #证件类型
    T['TFileBusinessCode'] = c_char #文件业务功能
    T['TCashExchangeCode'] = c_char #汇钞标志
    T['TYesNoIndicator'] = c_char #是或否标识
    T['TBanlanceType'] = c_char #余额类型
    T['TGender'] = c_char #性别
    T['TFeePayFlag'] = c_char #费用支付标志
    T['TPassWordKeyType'] = c_char #密钥类型
    T['TFBTPassWordType'] = c_char #密码类型
    T['TFBTEncryMode'] = c_char #加密方式
    T['TBankRepealFlag'] = c_char #银行冲正标志
    T['TBrokerRepealFlag'] = c_char #期商冲正标志
    T['TInstitutionType'] = c_char #机构类别
    T['TLastFragment'] = c_char #最后分片标志
    T['TBankAccStatus'] = c_char #银行账户状态
    T['TMoneyAccountStatus'] = c_char #资金账户状态
    T['TManageStatus'] = c_char #存管状态
    T['TSystemType'] = c_char #应用系统类型
    T['TTxnEndFlag'] = c_char #银期转帐划转结果标志
    T['TProcessStatus'] = c_char #银期转帐服务处理状态
    T['TCustType'] = c_char #客户类型
    T['TFBTTransferDirection'] = c_char #银期转帐方向
    T['TOpenOrDestroy'] = c_char #开销户类别
    T['TAvailabilityFlag'] = c_char #有效标志
    T['TOrganType'] = c_char #机构类型
    T['TOrganLevel'] = c_char #机构级别
    T['TProtocalID'] = c_char #协议类型
    T['TConnectMode'] = c_char #套接字连接方式
    T['TSyncMode'] = c_char #套接字通信方式
    T['TBankAccType'] = c_char #银行帐号类型
    T['TFutureAccType'] = c_char #期货公司帐号类型
    T['TOrganStatus'] = c_char #接入机构状态
    T['TCCBFeeMode'] = c_char #建行收费模式
    T['TCommApiType'] = c_char #通讯API类型
    T['TServiceID'] = c_int #服务编号
    T['TServiceLineNo'] = c_int #服务线路编号
    T['TServiceName'] = c_char * 61 #服务名
    T['TLinkStatus'] = c_char #连接状态
    T['TCommApiPointer'] = c_int #通讯API指针
    T['TPwdFlag'] = c_char #密码核对标志
    T['TSecuAccType'] = c_char #期货帐号类型
    T['TTransferStatus'] = c_char #转账交易状态
    T['TSponsorType'] = c_char #发起方
    T['TReqRspType'] = c_char #请求响应类别
    T['TFBTUserEventType'] = c_char #银期转帐用户事件类型
    T['TBankIDByBank'] = c_char * 21 #银行自己的编码
    T['TDBOPSeqNo'] = c_int #递增的序列号
    T['TTableName'] = c_char * 61 #FBT表名
    T['TPKName'] = c_char * 201 #FBT表操作主键名
    T['TPKValue'] = c_char * 501 #FBT表操作主键值
    T['TDBOperation'] = c_char #记录操作类型
    T['TSyncFlag'] = c_char #同步标记
    T['TTargetID'] = c_char * 4 #同步目标编号
    T['TSyncType'] = c_char #同步类型
    T['TNotifyClass'] = c_char #风险通知类型
    T['TRiskNofityInfo'] = c_char * 257 #客户风险通知消息
    T['TForceCloseSceneId'] = c_char * 24 #强平场景编号
    T['TForceCloseType'] = c_char #强平单类型
    T['TInstrumentIDs'] = c_char * 101 #多个产品代码,用+分隔,如cu+zn
    T['TRiskNotifyMethod'] = c_char #风险通知途径
    T['TRiskNotifyStatus'] = c_char #风险通知状态
    T['TRiskUserEvent'] = c_char #风控用户操作事件
    T['TParamID'] = c_int #参数代码
    T['TParamName'] = c_char * 41 #参数名
    T['TParamValue'] = c_char * 41 #参数值
    T['TConditionalOrderSortType'] = c_char #条件单索引条件
    T['TSendType'] = c_char #报送状态
    T['TClientIDStatus'] = c_char #交易编码状态
    T['TIndustryID'] = c_char * 17 #行业编码
    T['TQuestionID'] = c_char * 5 #特有信息编号
    T['TQuestionContent'] = c_char * 41 #特有信息说明
    T['TOptionID'] = c_char * 13 #选项编号
    T['TOptionContent'] = c_char * 61 #选项说明
    T['TQuestionType'] = c_char #特有信息类型
    T['TProcessID'] = c_char * 33 #业务流水号
    T['TSeqNo'] = c_int #流水号
    T['TUOAProcessStatus'] = c_char * 3 #流程状态
    T['TProcessType'] = c_char * 3 #流程功能类型
    T['TBusinessType'] = c_char #业务类型
    T['TCfmmcReturnCode'] = c_char #监控中心返回码
    T['TExReturnCode'] = c_int #交易所返回码
    T['TClientType'] = c_char #客户类型
    T['TExchangeIDType'] = c_char #交易所编号
    T['TExClientIDType'] = c_char #交易编码类型
    T['TClientClassify'] = c_char * 11 #客户分类码
    T['TUOAOrganType'] = c_char * 9 #单位性质
    T['TUOACountryCode'] = c_char * 9 #国家代码
    T['TAreaCode'] = c_char * 9 #区号
    T['TFuturesID'] = c_char * 21 #监控中心为客户分配的代码
    T['TCffmcDate'] = c_char * 11 #日期
    T['TCffmcTime'] = c_char * 11 #时间
    T['TNocID'] = c_char * 21 #组织机构代码
    T['TUpdateFlag'] = c_char #更新状态
    T['TApplyOperateID'] = c_char #申请动作
    T['TApplyStatusID'] = c_char #申请状态
    T['TSendMethod'] = c_char #发送方式
    T['TEventType'] = c_char * 33 #业务操作类型
    T['TEventMode'] = c_char #操作方法
    T['TUOAAutoSend'] = c_char #统一开户申请自动发送
    T['TQueryDepth'] = c_int #查询深度
    T['TDataCenterID'] = c_int #数据中心代码
    T['TFlowID'] = c_char #流程ID
    T['TCheckLevel'] = c_char #复核级别
    T['TCheckNo'] = c_int #操作次数
    T['TCheckStatus'] = c_char #复核级别
    T['TUsedStatus'] = c_char #生效状态
    T['TRateTemplateName'] = c_char * 61 #模型名称
    T['TPropertyString'] = c_char * 2049 #用于查询的投资属性字段
    T['TBankAcountOrigin'] = c_char #账户来源
    T['TMonthBillTradeSum'] = c_char #结算单月报成交汇总方式
    T['TFBTTradeCodeEnum'] = c_char #银期交易代码枚举
    T['TRateTemplateID'] = c_char * 9 #模型代码
    T['TRiskRate'] = c_char * 21 #风险度
    T['TTimestamp'] = c_int #时间戳
    T['TInvestorIDRuleName'] = c_char * 61 #号段规则名称
    T['TInvestorIDRuleExpr'] = c_char * 513 #号段规则表达式
    T['TLastDrift'] = c_int #上次O    T['TP']漂移值
    T['TLastSuccess'] = c_int #上次O    T['TP']成功值
    T['TAuthKey'] = c_char * 41 #令牌密钥
    T['TSerialNumber'] = c_char * 17 #序列号
    T['TOTPType'] = c_char #动态令牌类型
    T['TOTPVendorsID'] = c_char * 2 #动态令牌提供商
    T['TOTPVendorsName'] = c_char * 61 #动态令牌提供商名称
    T['TOTPStatus'] = c_char #动态令牌状态
    T['TBrokerUserType'] = c_char #经济公司用户类型
    T['TFutureType'] = c_char #期货类型
    T['TFundEventType'] = c_char #资金管理操作类型
    T['TAccountSourceType'] = c_char #资金账户来源
    T['TCodeSourceType'] = c_char #交易编码来源
    T['TUserRange'] = c_char #操作员范围
    T['TTimeSpan'] = c_char * 9 #时间跨度
    T['TImportSequenceID'] = c_char * 17 #动态令牌导入批次编号
    T['TByGroup'] = c_char #交易统计表按客户统计方式
    T['TTradeSumStatMode'] = c_char #交易统计表按范围统计方式
    T['TComType'] = c_int #组合成交类型
    T['TUserProductID'] = c_char * 33 #产品标识
    T['TUserProductName'] = c_char * 65 #产品名称
    T['TUserProductMemo'] = c_char * 129 #产品说明
    T['TCSRCCancelFlag'] = c_char * 2 #新增或变更标志
    T['TCSRCDate'] = c_char * 11 #日期
    T['TCSRCInvestorName'] = c_char * 81 #客户名称
    T['TCSRCInvestorID'] = c_char * 13 #客户代码
    T['TCSRCIdentifiedCardNo'] = c_char * 41 #证件号码
    T['TCSRCClientID'] = c_char * 11 #交易编码
    T['TCSRCBankFlag'] = c_char * 3 #银行标识
    T['TCSRCBankAccount'] = c_char * 23 #银行账户
    T['TCSRCOpenName'] = c_char * 41 #开户人
    T['TCSRCMemo'] = c_char * 101 #说明
    T['TCSRCTime'] = c_char * 11 #时间
    T['TCSRCTradeID'] = c_char * 21 #成交流水号
    T['TCSRCExchangeInstID'] = c_char * 7 #合约代码
    T['TCSRCMortgageName'] = c_char * 7 #质押品名称
    T['TCSRCReason'] = c_char * 3 #事由
    T['TIsSettlement'] = c_char * 2 #是否为非结算会员
    T['TCSRCMoney'] = c_double #资金
    T['TCSRCPrice'] = c_double #价格
    T['TCommModelName'] = c_char * 161 #手续费率模板名称
    T['TCommModelMemo'] = c_char * 1025 #手续费率模板备注
    T['TExprSetMode'] = c_char #日期表达式设置类型
    T['TRateInvestorRange'] = c_char #投资者范围
    T['TAgentBrokerID'] = c_char * 13 #代理经纪公司代码
    T['TDRIdentityID'] = c_int #交易中心代码
    T['TDRIdentityName'] = c_char * 65 #交易中心名称
    T['TDBLinkID'] = c_char * 31 #DBLink标识号
    T['TSyncDataStatus'] = c_char #主次用系统数据同步状态
    T['TTradeSource'] = c_char #成交来源
    T['TFlexStatMode'] = c_char #产品合约统计方式
    T['TByInvestorRange'] = c_char #投资者范围统计方式
    T['TSRiskRate'] = c_char * 21 #风险度
    T['TFBTBankID'] = c_char * 2 #银行标识
    T['TSequenceNo12'] = c_int #序号
    T['TPropertyInvestorRange'] = c_char #投资者范围
    T['TFileStatus'] = c_char #文件状态
    T['TFileGenStyle'] = c_char #文件生成方式
    T['TSysOperMode'] = c_char #系统日志操作方法
    T['TSysOperType'] = c_char #系统日志操作类型
    T['TCSRCDataQueyType'] = c_char #上报数据查询类型
    T['TFreezeStatus'] = c_char #休眠状态
    T['TStandardStatus'] = c_char #规范状态
    T['TCSRCFreezeStatus'] = c_char * 2 #休眠状态
    T['TRightParamType'] = c_char #配置类型
    T['TRightTemplateID'] = c_char * 9 #模板代码
    T['TRightTemplateName'] = c_char * 61 #模板名称
    T['TDataStatus'] = c_char #反洗钱审核表数据状态
    T['TAMLCheckStatus'] = c_char #审核状态
    T['TAmlDateType'] = c_char #日期类型
    T['TAmlCheckLevel'] = c_char #审核级别
    T['TAmlCheckFlow'] = c_char * 2 #反洗钱数据抽取审核流程
    T['TDataType'] = c_char * 129 #数据类型
    T['TExportFileType'] = c_char #导出文件类型
    T['TSettleManagerType'] = c_char #结算配置类型
    T['TSettleManagerID'] = c_char * 33 #结算配置代码
    T['TSettleManagerName'] = c_char * 129 #结算配置名称
    T['TSettleManagerLevel'] = c_char #结算配置等级
    T['TSettleManagerGroup'] = c_char #模块分组
    T['TCheckResultMemo'] = c_char * 1025 #核对结果说明
    T['TFunctionUrl'] = c_char * 1025 #功能链接
    T['TAuthInfo'] = c_char * 129 #客户端认证信息
    T['TAuthCode'] = c_char * 17 #客户端认证码
    T['TLimitUseType'] = c_char #保值额度使用类型
    T['TDataResource'] = c_char #数据来源
    T['TMarginType'] = c_char #保证金类型
    T['TActiveType'] = c_char #生效类型
    T['TMarginRateType'] = c_char #冲突保证金率类型
    T['TBackUpStatus'] = c_char #备份数据状态
    T['TInitSettlement'] = c_char #结算初始化状态
    T['TReportStatus'] = c_char #报表数据生成状态
    T['TSaveStatus'] = c_char #数据归档状态
    T['TCombineType'] = c_char * 25 #组合类型
    T['TSettArchiveStatus'] = c_char #结算确认数据归档状态
    T['TCTPType'] = c_char #C    T['TP']交易系统类型
    T['TToolID'] = c_char * 9 #工具代码
    T['TToolName'] = c_char * 81 #工具名称
    T['TCloseDealType'] = c_char #平仓处理类型
    T['TStartMode'] = c_char #启动模式
    T['TLoginMode'] = c_char #登录模式
