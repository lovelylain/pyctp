...
def main():
    user = TraderApi.CreateTraderApi("trader")
    user.RegisterSpi(myTraderSpi(broker_id="2030",investor_id="wang.yc",passwd="123456"))
    user.RegisterFront("tcp://asp-sim2-front1.financial-trading-platform.com:26205")
    user.Init()
