...
cdef extern from "ThostFtdcTraderApi.h":
    cdef cppclass CTraderApi "CThostFtdcTraderApi":
        ...
        int ReqLockInsert(CInputLockField *pInputLock, int nRequestID) nogil
        ...
        int ReqQryLock(CQryLockField *pQryLock, int nRequestID) nogil
        int ReqQryLockPosition(CQryLockPositionField *pQryLockPosition, int nRequestID) nogil
