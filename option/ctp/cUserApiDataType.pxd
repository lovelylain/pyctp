...
cdef extern from "ThostFtdcUserApiDataType.h":
    ...
    ctypedef char[31] TInstrumentCodeType "TThostFtdcInstrumentCodeType" #合约标识码
    ...
    enum: FC_LockInsert "THOST_FTDC_FC_LockInsert" #锁定与解锁权限
    ...
    enum: BFC_LockInsert "THOST_FTDC_BFC_LockInsert" #锁定与解锁权限
    ...
    enum: PC_ETFOption "THOST_FTDC_PC_ETFOption" #个股期权
    enum: PC_Stock "THOST_FTDC_PC_Stock" #证券
    ...
    enum: HF_Covered "THOST_FTDC_HF_Covered" #备兑
    ...
    enum: TPID_IsPosiFreeze "THOST_FTDC_TPID_IsPosiFreeze" #是否冻结证券持仓
    enum: TPID_IsPosiLimit "THOST_FTDC_TPID_IsPosiLimit" #是否限仓
    ...
    ctypedef char[9] TBranchIDType "TThostFtdcBranchIDType" #营业部编号
    ...
    ctypedef char[65] TDBFComdTypeType "TThostFtdcDBFComdTypeType" #DBF命令类型
    ctypedef char[65] TDBFComTimeType "TThostFtdcDBFComTimeType" #DBF时间类型
    ctypedef char[17] TDBFComNoType "TThostFtdcDBFComNoType" #DBF流水号类型
    ctypedef char[256] TDBFFdNameType "TThostFtdcDBFFdNameType" #DBF字段类型
    ctypedef char[256] TDBFFdContentType "TThostFtdcDBFFdContentType" #DBF字段内容类型
    ...
    ctypedef char TLockTypeType "TThostFtdcLockTypeType" #锁定方向
    enum: LCKT_Lock "THOST_FTDC_LCKT_Lock" #锁定
    enum: LCKT_Unlock "THOST_FTDC_LCKT_Unlock" #解锁
    ctypedef char TBizTypeType "TThostFtdcBizTypeType" #业务类型
    enum: BZTP_Future "THOST_FTDC_BZTP_Future" #期货
    enum: BZTP_Stock "THOST_FTDC_BZTP_Stock" #证券
    ctypedef char TDesignateTypeType "TThostFtdcDesignateTypeType" #指定类型
    enum: DSTP_Register "THOST_FTDC_DSTP_Register" #指定登记
    enum: DSTP_Cancel "THOST_FTDC_DSTP_Cancel" #指定撤销
    ctypedef char TFreezeReasonTypeType "TThostFtdcFreezeReasonTypeType" #冻结原因
    enum: FRTP_Init "THOST_FTDC_FRTP_Init" #初始化
    enum: FRTP_Lock "THOST_FTDC_FRTP_Lock" #锁定
    enum: FRTP_Exec "THOST_FTDC_FRTP_Exec" #执行
    ctypedef char TFreezeTypeType "TThostFtdcFreezeTypeType" #冻结类型
    enum: FZTP_Freeze "THOST_FTDC_FZTP_Freeze" #冻结
    enum: FZTP_Unfreeze "THOST_FTDC_FZTP_Unfreeze" #解冻
    enum: FZTP_Force "THOST_FTDC_FZTP_Force" #强制执行
    ctypedef char TTradeSystemTypeType "TThostFtdcTradeSystemTypeType" #交易系统类型
    enum: TSTP_Unknow "THOST_FTDC_TSTP_Unknow" #未知系统
    enum: TSTP_Future "THOST_FTDC_TSTP_Future" #期货系统
    enum: TSTP_IShare "THOST_FTDC_TSTP_IShare" #个股系统
    ctypedef char TStockDisposalTypeType "TThostFtdcStockDisposalTypeType" #证券处置方向
    enum: STPT_ToBroker "THOST_FTDC_STPT_ToBroker" #划入经纪公司账户
    enum: STPT_ToInvestor "THOST_FTDC_STPT_ToInvestor" #划入投资者账户
    ctypedef char[21] TStockDisposalSysIDType "TThostFtdcStockDisposalSysIDType" #证券处置编号
    ctypedef char TStockDisposalStatusType "TThostFtdcStockDisposalStatusType" #报单操作状态
    enum: SDPS_Submitted "THOST_FTDC_SDPS_Submitted" #已经提交
    enum: SDPS_Accepted "THOST_FTDC_SDPS_Accepted" #已经接受
    enum: SDPS_Rejected "THOST_FTDC_SDPS_Rejected" #已经被拒绝
    enum: SDPS_Cancelled "THOST_FTDC_SDPS_Cancelled" #已经被撤销
